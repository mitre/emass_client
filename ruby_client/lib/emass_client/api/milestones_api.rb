...
module EmassClient
  class MilestonesApi
    ...
    # @param system_id [Integer] **System Id**: The unique system record identifier.
    # @param poam_id [Integer] **POA&amp;M Id**: The unique POA&amp;M record identifier.
    # @param delete_poams_inner1 [Array<DeletePoamsInner1>] Delete the given Milestone Id
    # @param [Hash] opts the optional parameters
    # @return [MilestonesPutPostDelete]
    def delete_milestone(system_id, poam_id, delete_poams_inner1, opts = {})
      data, _status_code, _headers = delete_milestone_with_http_info(system_id, poam_id, delete_poams_inner1, opts)
      data
    end
    ...
    def delete_milestone_with_http_info(system_id, poam_id, delete_poams_inner1, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'delete_poams_inner1' is set
      if @api_client.config.client_side_validation && delete_poams_inner1.nil?
        fail ArgumentError, "Missing the required parameter 'delete_poams_inner1' when calling MilestonesApi.delete_milestone"
      end
      # resource path
      local_var_path = '/api/systems/{systemId}/poams/{poamId}/milestones'.sub('{' + 'systemId' + '}', CGI.escape(system_id.to_s)).sub('{' + 'poamId' + '}', CGI.escape(poam_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(delete_poams_inner1)
