# EmassClient::SystemHardwareDashboardsApi

All URIs are relative to *http://localhost:4010*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**get_system_hardware_details**](SystemHardwareDashboardsApi.md#get_system_hardware_details) | **GET** /api/dashboards/system-hardware-details | System Hardware Details |
| [**get_system_hardware_summary**](SystemHardwareDashboardsApi.md#get_system_hardware_summary) | **GET** /api/dashboards/system-hardware-summary | System Hardware Summary |


## get_system_hardware_details

> <GetSystemStatusDetails200Response> get_system_hardware_details(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemHardwareDashboardsApi->get_system_hardware_details: #{e}"
end
```
...
> <Array(<GetSystemStatusDetails200Response>, Integer, Hash)> get_system_hardware_details_with_http_info(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemHardwareDashboardsApi->get_system_hardware_details_with_http_info: #{e}"
end
```
...
> <GetSystemStatusDetails200Response> get_system_hardware_summary(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemHardwareDashboardsApi->get_system_hardware_summary: #{e}"
end
```
...
> <Array(<GetSystemStatusDetails200Response>, Integer, Hash)> get_system_hardware_summary_with_http_info(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemHardwareDashboardsApi->get_system_hardware_summary_with_http_info: #{e}"
end
```
