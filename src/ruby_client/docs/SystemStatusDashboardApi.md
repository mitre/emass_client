# EmassClient::SystemStatusDashboardApi
...
> <GetSystemStatusDetails200Response> get_system_status_details(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemStatusDashboardApi->get_system_status_details: #{e}"
end
```
...
> <Array(<GetSystemStatusDetails200Response>, Integer, Hash)> get_system_status_details_with_http_info(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemStatusDashboardApi->get_system_status_details_with_http_info: #{e}"
end
```
