# EmassClient::SystemSecurityControlsDashboardsApi
...
> <GetSystemStatusDetails200Response> get_system_assessment_procedures_details(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemSecurityControlsDashboardsApi->get_system_assessment_procedures_details: #{e}"
end
```
...
> <Array(<GetSystemStatusDetails200Response>, Integer, Hash)> get_system_assessment_procedures_details_with_http_info(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemSecurityControlsDashboardsApi->get_system_assessment_procedures_details_with_http_info: #{e}"
end
```
...
> <GetSystemStatusDetails200Response> get_system_control_compliance_summary(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemSecurityControlsDashboardsApi->get_system_control_compliance_summary: #{e}"
end
```
...
> <Array(<GetSystemStatusDetails200Response>, Integer, Hash)> get_system_control_compliance_summary_with_http_info(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemSecurityControlsDashboardsApi->get_system_control_compliance_summary_with_http_info: #{e}"
end
```
...
> <GetSystemStatusDetails200Response> get_system_security_control_details(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemSecurityControlsDashboardsApi->get_system_security_control_details: #{e}"
end
```
...
> <Array(<GetSystemStatusDetails200Response>, Integer, Hash)> get_system_security_control_details_with_http_info(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemSecurityControlsDashboardsApi->get_system_security_control_details_with_http_info: #{e}"
end
```
