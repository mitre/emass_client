# EmassClient::SystemPOAMDashboardsApi

All URIs are relative to *http://localhost:4010*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**get_system_poam_details**](SystemPOAMDashboardsApi.md#get_system_poam_details) | **GET** /api/dashboards/system-poam-details | System POA&amp;M Details |
| [**get_system_poam_summary**](SystemPOAMDashboardsApi.md#get_system_poam_summary) | **GET** /api/dashboards/system-poam-summary | System POA&amp;M Summary |


## get_system_poam_details

> <GetSystemStatusDetails200Response> get_system_poam_details(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemPOAMDashboardsApi->get_system_poam_details: #{e}"
end
```
...
> <Array(<GetSystemStatusDetails200Response>, Integer, Hash)> get_system_poam_details_with_http_info(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemPOAMDashboardsApi->get_system_poam_details_with_http_info: #{e}"
end
```
...
> <GetSystemStatusDetails200Response> get_system_poam_summary(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemPOAMDashboardsApi->get_system_poam_summary: #{e}"
end
```
...
> <Array(<GetSystemStatusDetails200Response>, Integer, Hash)> get_system_poam_summary_with_http_info(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemPOAMDashboardsApi->get_system_poam_summary_with_http_info: #{e}"
end
```
