# EmassClient::CMMCAssessmentDashboardsApi
...
> <Array(<GetSystemStatusDetails200Response>, Integer, Hash)> get_cmmc_assessment_requirements_compliance_summary_with_http_info(org_id, opts)
