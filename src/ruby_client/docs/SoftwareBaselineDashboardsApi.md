# EmassClient::SoftwareBaselineDashboardsApi

All URIs are relative to *http://localhost:4010*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**get_system_software_details**](SoftwareBaselineDashboardsApi.md#get_system_software_details) | **GET** /api/dashboards/system-software-details | System Software Details |
| [**get_system_software_summary**](SoftwareBaselineDashboardsApi.md#get_system_software_summary) | **GET** /api/dashboards/system-software-summary | System Software Summary |
...
api_instance = EmassClient::SoftwareBaselineDashboardsApi.new
...
begin
  ...
  puts "Error when calling SoftwareBaselineDashboardsApi->get_system_software_details: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SoftwareBaselineDashboardsApi->get_system_software_details_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SoftwareBaselineDashboardsApi->get_system_software_summary: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SoftwareBaselineDashboardsApi->get_system_software_summary_with_http_info: #{e}"
end
```
