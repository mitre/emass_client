# EmassClient::EnterpriseArtifactsDashboardsApi
...
api_instance = EmassClient::EnterpriseArtifactsDashboardsApi.new
...
begin
  ...
  puts "Error when calling EnterpriseArtifactsDashboardsApi->get_system_artifacts_details: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EnterpriseArtifactsDashboardsApi->get_system_artifacts_details_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EnterpriseArtifactsDashboardsApi->get_system_artifacts_summary: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EnterpriseArtifactsDashboardsApi->get_system_artifacts_summary_with_http_info: #{e}"
end
```
