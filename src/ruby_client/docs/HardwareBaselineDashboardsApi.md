# EmassClient::HardwareBaselineDashboardsApi
...
api_instance = EmassClient::HardwareBaselineDashboardsApi.new
...
begin
  ...
  puts "Error when calling HardwareBaselineDashboardsApi->get_system_hardware_details: #{e}"
end
```
...
begin
  ...
  puts "Error when calling HardwareBaselineDashboardsApi->get_system_hardware_details_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling HardwareBaselineDashboardsApi->get_system_hardware_summary: #{e}"
end
```
...
begin
  ...
  puts "Error when calling HardwareBaselineDashboardsApi->get_system_hardware_summary_with_http_info: #{e}"
end
```
