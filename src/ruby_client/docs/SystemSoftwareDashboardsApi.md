# EmassClient::SystemSoftwareDashboardsApi

All URIs are relative to *http://localhost:4010*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**get_system_software_details**](SystemSoftwareDashboardsApi.md#get_system_software_details) | **GET** /api/dashboards/system-software-details | System Software Details |
| [**get_system_software_summary**](SystemSoftwareDashboardsApi.md#get_system_software_summary) | **GET** /api/dashboards/system-software-summary | System Software Summary |


## get_system_software_details

> <GetSystemStatusDetails200Response> get_system_software_details(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemSoftwareDashboardsApi->get_system_software_details: #{e}"
end
```
...
> <Array(<GetSystemStatusDetails200Response>, Integer, Hash)> get_system_software_details_with_http_info(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemSoftwareDashboardsApi->get_system_software_details_with_http_info: #{e}"
end
```
...
> <GetSystemStatusDetails200Response> get_system_software_summary(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemSoftwareDashboardsApi->get_system_software_summary: #{e}"
end
```
...
> <Array(<GetSystemStatusDetails200Response>, Integer, Hash)> get_system_software_summary_with_http_info(org_id, opts)
...
begin
  ...
  puts "Error when calling SystemSoftwareDashboardsApi->get_system_software_summary_with_http_info: #{e}"
end
```
