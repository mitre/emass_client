...
# Unit tests for EmassClient::Unauthorized
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EmassClient::Unauthorized do
  let(:instance) { EmassClient::Unauthorized.new }

  describe 'test an instance of Unauthorized' do
    it 'should create an instance of Unauthorized' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(EmassClient::Unauthorized)
    end
  end
