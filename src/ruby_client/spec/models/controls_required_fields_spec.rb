...
# Unit tests for EmassClient::ControlsRequiredFields
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EmassClient::ControlsRequiredFields do
  let(:instance) { EmassClient::ControlsRequiredFields.new }

  describe 'test an instance of ControlsRequiredFields' do
    it 'should create an instance of ControlsRequiredFields' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(EmassClient::ControlsRequiredFields)
    end
  end
