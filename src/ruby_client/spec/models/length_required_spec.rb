...
# Unit tests for EmassClient::LengthRequired
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EmassClient::LengthRequired do
  let(:instance) { EmassClient::LengthRequired.new }

  describe 'test an instance of LengthRequired' do
    it 'should create an instance of LengthRequired' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(EmassClient::LengthRequired)
    end
  end
