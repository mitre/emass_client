...
# Unit tests for EmassClient::InternalServerError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EmassClient::InternalServerError do
  let(:instance) { EmassClient::InternalServerError.new }

  describe 'test an instance of InternalServerError' do
    it 'should create an instance of InternalServerError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(EmassClient::InternalServerError)
    end
  end
