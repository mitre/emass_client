...
# Unit tests for EmassClient::SwBaselineIds
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EmassClient::SwBaselineIds do
  let(:instance) { EmassClient::SwBaselineIds.new }

  describe 'test an instance of SwBaselineIds' do
    it 'should create an instance of SwBaselineIds' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(EmassClient::SwBaselineIds)
    end
  end
