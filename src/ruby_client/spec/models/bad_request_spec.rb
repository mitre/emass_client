...
# Unit tests for EmassClient::BadRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EmassClient::BadRequest do
  let(:instance) { EmassClient::BadRequest.new }

  describe 'test an instance of BadRequest' do
    it 'should create an instance of BadRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(EmassClient::BadRequest)
    end
  end
