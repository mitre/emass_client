...
# Unit tests for EmassClient::ControlsReadOnlyFields
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EmassClient::ControlsReadOnlyFields do
  let(:instance) { EmassClient::ControlsReadOnlyFields.new }

  describe 'test an instance of ControlsReadOnlyFields' do
    it 'should create an instance of ControlsReadOnlyFields' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(EmassClient::ControlsReadOnlyFields)
    end
  end
