...
# Unit tests for EmassClient::ControlsResponseGetDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EmassClient::ControlsResponseGetDataInner do
  let(:instance) { EmassClient::ControlsResponseGetDataInner.new }

  describe 'test an instance of ControlsResponseGetDataInner' do
    it 'should create an instance of ControlsResponseGetDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(EmassClient::ControlsResponseGetDataInner)
    end
  end
