...
# Unit tests for EmassClient::APIRuleFailed
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EmassClient::APIRuleFailed do
  let(:instance) { EmassClient::APIRuleFailed.new }

  describe 'test an instance of APIRuleFailed' do
    it 'should create an instance of APIRuleFailed' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(EmassClient::APIRuleFailed)
    end
  end
