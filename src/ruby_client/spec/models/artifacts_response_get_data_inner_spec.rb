...
# Unit tests for EmassClient::ArtifactsResponseGetDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EmassClient::ArtifactsResponseGetDataInner do
  let(:instance) { EmassClient::ArtifactsResponseGetDataInner.new }

  describe 'test an instance of ArtifactsResponseGetDataInner' do
    it 'should create an instance of ArtifactsResponseGetDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(EmassClient::ArtifactsResponseGetDataInner)
    end
  end
  ...
  describe 'test attribute "reference_page_number"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "assessment_procedures"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
