...
# Unit tests for EmassClient::ArtifactsIds
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EmassClient::ArtifactsIds do
  let(:instance) { EmassClient::ArtifactsIds.new }

  describe 'test an instance of ArtifactsIds' do
    it 'should create an instance of ArtifactsIds' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(EmassClient::ArtifactsIds)
    end
  end
