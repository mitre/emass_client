...
# Unit tests for EmassClient::SystemCriticalAssetsDashboardApi
...
describe 'SystemCriticalAssetsDashboardApi' do
  ...
  # unit tests for get_system_critical_assets_summary
  ...
  describe 'get_system_critical_assets_summary test' do
    it 'should work' do
