...
# Unit tests for EmassClient::PortsAndProtocolsDashboardsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PortsAndProtocolsDashboardsApi' do
  before do
  ...
  describe 'test an instance of PortsAndProtocolsDashboardsApi' do
    it 'should create an instance of PortsAndProtocolsDashboardsApi' do
      expect(@api_instance).to be_instance_of(EmassClient::PortsAndProtocolsDashboardsApi)
    end
  end
