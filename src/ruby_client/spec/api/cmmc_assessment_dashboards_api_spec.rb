...
# Unit tests for EmassClient::CMMCAssessmentDashboardsApi
...
describe 'CMMCAssessmentDashboardsApi' do
  ...
  # unit tests for get_cmmc_assessment_requirement_objectives_details
  ...
  describe 'get_cmmc_assessment_requirement_objectives_details test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_cmmc_assessment_requirements_compliance_summary
  ...
  # @option opts [Integer] :page_size **Page Size**: If no value is specified, the default returns 20000 per page. 
  # @return [GetSystemStatusDetails200Response]
  describe 'get_cmmc_assessment_requirements_compliance_summary test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_cmmc_assessment_security_requirements_details
  ...
  # @option opts [Integer] :page_size **Page Size**: If no value is specified, the default returns 20000 per page. 
  # @return [GetSystemStatusDetails200Response]
  describe 'get_cmmc_assessment_security_requirements_details test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_cmmc_assessment_status_summary
  ...
  # @option opts [Integer] :page_size **Page Size**: If no value is specified, the default returns 20000 per page. 
  # @return [GetSystemStatusDetails200Response]
  describe 'get_cmmc_assessment_status_summary test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
