...
# Unit tests for EmassClient::CoastGuardSystemFISMAMetricsDashboardApi
...
describe 'CoastGuardSystemFISMAMetricsDashboardApi' do
  ...
  # unit tests for get_coast_guard_system_fisma_metrics
  ...
  describe 'get_coast_guard_system_fisma_metrics test' do
    it 'should work' do
