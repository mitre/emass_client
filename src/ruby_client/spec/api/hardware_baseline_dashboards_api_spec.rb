...
# Unit tests for EmassClient::HardwareBaselineDashboardsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'HardwareBaselineDashboardsApi' do
  before do
  ...
  describe 'test an instance of HardwareBaselineDashboardsApi' do
    it 'should create an instance of HardwareBaselineDashboardsApi' do
      expect(@api_instance).to be_instance_of(EmassClient::HardwareBaselineDashboardsApi)
    end
  end
