...
# Unit tests for EmassClient::SystemConnectivityCCSDDashboardsApi
...
describe 'SystemConnectivityCCSDDashboardsApi' do
  ...
  # unit tests for get_system_connectivity_ccsd_details
  ...
  describe 'get_system_connectivity_ccsd_details test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_system_connectivity_ccsd_summary
  ...
  # @option opts [Integer] :page_size **Page Size**: If no value is specified, the default returns 20000 per page. 
  # @return [GetSystemStatusDetails200Response]
  describe 'get_system_connectivity_ccsd_summary test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
