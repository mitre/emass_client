...
# Unit tests for EmassClient::PrivacyComplianceDashboardsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrivacyComplianceDashboardsApi' do
  before do
  ...
  describe 'test an instance of PrivacyComplianceDashboardsApi' do
    it 'should create an instance of PrivacyComplianceDashboardsApi' do
      expect(@api_instance).to be_instance_of(EmassClient::PrivacyComplianceDashboardsApi)
    end
  end
