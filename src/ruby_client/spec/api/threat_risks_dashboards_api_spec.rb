...
# Unit tests for EmassClient::ThreatRisksDashboardsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ThreatRisksDashboardsApi' do
  before do
  ...
  describe 'test an instance of ThreatRisksDashboardsApi' do
    it 'should create an instance of ThreatRisksDashboardsApi' do
      expect(@api_instance).to be_instance_of(EmassClient::ThreatRisksDashboardsApi)
    end
  end
