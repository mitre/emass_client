...
# Unit tests for EmassClient::UsersDashboardApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UsersDashboardApi' do
  before do
  ...
  describe 'test an instance of UsersDashboardApi' do
    it 'should create an instance of UsersDashboardApi' do
      expect(@api_instance).to be_instance_of(EmassClient::UsersDashboardApi)
    end
  end
