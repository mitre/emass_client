...
# Unit tests for EmassClient::EnterprisePOAMDashboardsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'EnterprisePOAMDashboardsApi' do
  before do
  ...
  describe 'test an instance of EnterprisePOAMDashboardsApi' do
    it 'should create an instance of EnterprisePOAMDashboardsApi' do
      expect(@api_instance).to be_instance_of(EmassClient::EnterprisePOAMDashboardsApi)
    end
  end
