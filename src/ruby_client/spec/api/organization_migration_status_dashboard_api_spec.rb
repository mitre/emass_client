...
# Unit tests for EmassClient::OrganizationMigrationStatusDashboardApi
...
describe 'OrganizationMigrationStatusDashboardApi' do
  ...
  # unit tests for get_organization_migration_status_summary
  ...
  describe 'get_organization_migration_status_summary test' do
    it 'should work' do
