...
# Unit tests for EmassClient::SystemA20SummaryDashboardApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SystemA20SummaryDashboardApi' do
  before do
  ...
  describe 'test an instance of SystemA20SummaryDashboardApi' do
    it 'should create an instance of SystemA20SummaryDashboardApi' do
      expect(@api_instance).to be_instance_of(EmassClient::SystemA20SummaryDashboardApi)
    end
  end
