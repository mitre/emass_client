...
# Unit tests for EmassClient::SystemAASummaryDashboardApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SystemAASummaryDashboardApi' do
  before do
  ...
  describe 'test an instance of SystemAASummaryDashboardApi' do
    it 'should create an instance of SystemAASummaryDashboardApi' do
      expect(@api_instance).to be_instance_of(EmassClient::SystemAASummaryDashboardApi)
    end
  end
