...
# Unit tests for EmassClient::FISMAInventorySummaryDashboardsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FISMAInventorySummaryDashboardsApi' do
  before do
  ...
  describe 'test an instance of FISMAInventorySummaryDashboardsApi' do
    it 'should create an instance of FISMAInventorySummaryDashboardsApi' do
      expect(@api_instance).to be_instance_of(EmassClient::FISMAInventorySummaryDashboardsApi)
    end
  end
