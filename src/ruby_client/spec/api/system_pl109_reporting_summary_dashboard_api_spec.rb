...
# Unit tests for EmassClient::SystemPL109ReportingSummaryDashboardApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SystemPL109ReportingSummaryDashboardApi' do
  before do
  ...
  describe 'test an instance of SystemPL109ReportingSummaryDashboardApi' do
    it 'should create an instance of SystemPL109ReportingSummaryDashboardApi' do
      expect(@api_instance).to be_instance_of(EmassClient::SystemPL109ReportingSummaryDashboardApi)
    end
  end
