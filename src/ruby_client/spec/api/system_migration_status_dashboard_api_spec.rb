...
# Unit tests for EmassClient::SystemMigrationStatusDashboardApi
...
describe 'SystemMigrationStatusDashboardApi' do
  ...
  # unit tests for get_system_migration_status_summary
  ...
  describe 'get_system_migration_status_summary test' do
    it 'should work' do
