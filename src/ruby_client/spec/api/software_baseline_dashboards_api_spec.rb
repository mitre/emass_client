...
# Unit tests for EmassClient::SoftwareBaselineDashboardsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SoftwareBaselineDashboardsApi' do
  before do
  ...
  describe 'test an instance of SoftwareBaselineDashboardsApi' do
    it 'should create an instance of SoftwareBaselineDashboardsApi' do
      expect(@api_instance).to be_instance_of(EmassClient::SoftwareBaselineDashboardsApi)
    end
  end
