...
module EmassClient
  class ContainersResourcesPostDelete
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EmassClient::ContainersResourcesPostDelete` initialize method"
      end
