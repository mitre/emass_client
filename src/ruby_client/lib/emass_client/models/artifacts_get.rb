...
module EmassClient
  class ArtifactsGet
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ["Procedure", "Diagram", "Policy", "Labor", "Document", "Image", "Other", "Scan Result", "Auditor Report"])
      return false unless type_validator.valid?(@type)
      category_validator = EnumAttributeValidator.new('String', ["Implementation Guidance", "Evidence"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["Procedure", "Diagram", "Policy", "Labor", "Document", "Image", "Other", "Scan Result", "Auditor Report"])
    ...
    def category=(category)
      validator = EnumAttributeValidator.new('String', ["Implementation Guidance", "Evidence"])
