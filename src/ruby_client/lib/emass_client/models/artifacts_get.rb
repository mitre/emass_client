...
module EmassClient
  class ArtifactsGet
    ...
    def hash
      [system_id, filename, is_inherited, is_template, type, category, name, description, reference_page_number, ccis, controls, assessment_procedures, mime_content_type, file_size, expiration_date, last_reviewed_date, signed_date].hash
    end
