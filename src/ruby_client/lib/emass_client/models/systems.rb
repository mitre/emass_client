...
module EmassClient
  class Systems
    ...
    def valid?
      policy_validator = EnumAttributeValidator.new('String', ["RMF", "DIACAP"])
      return false unless policy_validator.valid?(@policy)
      registration_type_validator = EnumAttributeValidator.new('String', ["Assess and Authorize", "Assess Only", "Guest", "Regular", "Functional", "Cloud Service Provider", "Common Control Provider"])
      return false unless registration_type_validator.valid?(@registration_type)
      system_type_validator = EnumAttributeValidator.new('String', ["IS Major Application", "IS Enclave", "Platform IT", "Platform IT System", "Platform IT Interconnection", "AIS Application", "Outsourced IT-Based Process (DoD-controlled)", "Enclave", "Outsourced IT-Based Process (service provider shared)"])
      ...
      security_plan_approval_status_validator = EnumAttributeValidator.new('String', ["Approved", "Not Yet Approved", "Denied"])
      return false unless security_plan_approval_status_validator.valid?(@security_plan_approval_status)
      mission_criticality_validator = EnumAttributeValidator.new('String', ["Mission Critical (MC)", "Mission Essential (ME)", "Mission Support (MS)"])
      return false unless mission_criticality_validator.valid?(@mission_criticality)
      geographical_association_validator = EnumAttributeValidator.new('String', ["VA Operated IS", "non-VA Operated IS"])
      return false unless geographical_association_validator.valid?(@geographical_association)
      governing_mission_area_validator = EnumAttributeValidator.new('String', ["Business MA (BMA)", "DoD portion of the Intelligence MA (DIMA)", "Enterprise Information Environment MA (EIEMA)", "Warfighting MA (WMA)"])
      return false unless governing_mission_area_validator.valid?(@governing_mission_area)
      primary_control_set_validator = EnumAttributeValidator.new('String', ["NIST SP 800-53 Revision 4", "DoDI 8500.2"])
      return false unless primary_control_set_validator.valid?(@primary_control_set)
      confidentiality_validator = EnumAttributeValidator.new('String', ["High", "Moderate", "Low"])
      return false unless confidentiality_validator.valid?(@confidentiality)
      integrity_validator = EnumAttributeValidator.new('String', ["High", "Moderate", "Low"])
      return false unless integrity_validator.valid?(@integrity)
      availability_validator = EnumAttributeValidator.new('String', ["High", "Moderate", "Low"])
      return false unless availability_validator.valid?(@availability)
      mac_validator = EnumAttributeValidator.new('String', ["I", "II", "III"])
      return false unless mac_validator.valid?(@mac)
      dod_confidentiality_validator = EnumAttributeValidator.new('String', ["Public", "Sensitive", "Classified"])
      return false unless dod_confidentiality_validator.valid?(@dod_confidentiality)
      impact_validator = EnumAttributeValidator.new('String', ["Low", "Moderate", "High"])
      return false unless impact_validator.valid?(@impact)
      pia_status_validator = EnumAttributeValidator.new('String', ["Not Started", "In Progress", "Completed"])
      return false unless pia_status_validator.valid?(@pia_status)
      current_rmf_lifecycle_step_validator = EnumAttributeValidator.new('String', ["1 - Categorize", "2 - Select", "3 - Implement", "4 - Assess", "5 - Authorize", "6 - Monitor"])
    ...
    def policy=(policy)
      validator = EnumAttributeValidator.new('String', ["RMF", "DIACAP"])
    ...
    def registration_type=(registration_type)
      validator = EnumAttributeValidator.new('String', ["Assess and Authorize", "Assess Only", "Guest", "Regular", "Functional", "Cloud Service Provider", "Common Control Provider"])
    ...
    def system_type=(system_type)
      validator = EnumAttributeValidator.new('String', ["IS Major Application", "IS Enclave", "Platform IT", "Platform IT System", "Platform IT Interconnection", "AIS Application", "Outsourced IT-Based Process (DoD-controlled)", "Enclave", "Outsourced IT-Based Process (service provider shared)"])
    ...
    def security_plan_approval_status=(security_plan_approval_status)
      validator = EnumAttributeValidator.new('String', ["Approved", "Not Yet Approved", "Denied"])
    ...
    def mission_criticality=(mission_criticality)
      validator = EnumAttributeValidator.new('String', ["Mission Critical (MC)", "Mission Essential (ME)", "Mission Support (MS)"])
    ...
    def geographical_association=(geographical_association)
      validator = EnumAttributeValidator.new('String', ["VA Operated IS", "non-VA Operated IS"])
    ...
    def governing_mission_area=(governing_mission_area)
      validator = EnumAttributeValidator.new('String', ["Business MA (BMA)", "DoD portion of the Intelligence MA (DIMA)", "Enterprise Information Environment MA (EIEMA)", "Warfighting MA (WMA)"])
    ...
    def primary_control_set=(primary_control_set)
      validator = EnumAttributeValidator.new('String', ["NIST SP 800-53 Revision 4", "DoDI 8500.2"])
    ...
    def mac=(mac)
      validator = EnumAttributeValidator.new('String', ["I", "II", "III"])
    ...
    def dod_confidentiality=(dod_confidentiality)
      validator = EnumAttributeValidator.new('String', ["Public", "Sensitive", "Classified"])
    ...
    def impact=(impact)
      validator = EnumAttributeValidator.new('String', ["Low", "Moderate", "High"])
    ...
    def pia_status=(pia_status)
      validator = EnumAttributeValidator.new('String', ["Not Started", "In Progress", "Completed"])
    ...
    def current_rmf_lifecycle_step=(current_rmf_lifecycle_step)
      validator = EnumAttributeValidator.new('String', ["1 - Categorize", "2 - Select", "3 - Implement", "4 - Assess", "5 - Authorize", "6 - Monitor"])
