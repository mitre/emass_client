...
module EmassClient
  class PoamGet
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["Ongoing", "Risk Accepted", "Completed", "Not Applicable", "Archived"])
      return false unless status_validator.valid?(@status)
      review_status_validator = EnumAttributeValidator.new('String', ["Not Approved", "Under Review", "Approved"])
      ...
      raw_severity_validator = EnumAttributeValidator.new('String', ["I", "II", "III"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["Ongoing", "Risk Accepted", "Completed", "Not Applicable", "Archived"])
    ...
    def review_status=(review_status)
      validator = EnumAttributeValidator.new('String', ["Not Approved", "Under Review", "Approved"])
