...
module EmassClient
  class ControlsGet
    ...
    def valid?
      modified_by_overlays_validator = EnumAttributeValidator.new('String', ["Privacy", "Requirements", "Concurrency"])
      return false unless modified_by_overlays_validator.valid?(@modified_by_overlays)
      implementation_status_validator = EnumAttributeValidator.new('String', ["Planned", "Implemented", "Inherited", "Not Applicable", "Manually Inherited"])
      return false unless implementation_status_validator.valid?(@implementation_status)
      common_control_provider_validator = EnumAttributeValidator.new('String', ["DoD", "Component", "Enclave"])
      return false unless common_control_provider_validator.valid?(@common_control_provider)
      control_designation_validator = EnumAttributeValidator.new('String', ["Common", "System-Specific", "Hybrid"])
      return false unless control_designation_validator.valid?(@control_designation)
      slcm_frequency_validator = EnumAttributeValidator.new('String', ["Constantly", "Daily", "Weekly", "Monthly", "Quarterly", "Semi-Annually", "Annually", "Every Two Years", "Every Three Years", "Undetermined"])
      return false unless slcm_frequency_validator.valid?(@slcm_frequency)
      slcm_method_validator = EnumAttributeValidator.new('String', ["Automated", "Semi-Automated", "Manual", "Undetermined"])
      return false unless slcm_method_validator.valid?(@slcm_method)
      severity_validator = EnumAttributeValidator.new('String', ["Very Low", "Low", "Moderate", "High", "Very High"])
      return false unless severity_validator.valid?(@severity)
      relevance_of_threat_validator = EnumAttributeValidator.new('String', ["Very Low", "Low", "Moderate", "High", "Very High"])
      return false unless relevance_of_threat_validator.valid?(@relevance_of_threat)
      likelihood_validator = EnumAttributeValidator.new('String', ["Very Low", "Low", "Moderate", "High", "Very High"])
      return false unless likelihood_validator.valid?(@likelihood)
      impact_validator = EnumAttributeValidator.new('String', ["Very Low", "Low", "Moderate", "High", "Very High"])
      return false unless impact_validator.valid?(@impact)
      residual_risk_level_validator = EnumAttributeValidator.new('String', ["Very Low", "Low", "Moderate", "High", "Very High"])
      return false unless residual_risk_level_validator.valid?(@residual_risk_level)
      test_method_validator = EnumAttributeValidator.new('String', ["Test", "Interview", "Examine", "Test, Interview", "Test, Examine", "Interview, Examine", "Test, Interview, Examine"])
    ...
    def modified_by_overlays=(modified_by_overlays)
      validator = EnumAttributeValidator.new('String', ["Privacy", "Requirements", "Concurrency"])
    ...
    def implementation_status=(implementation_status)
      validator = EnumAttributeValidator.new('String', ["Planned", "Implemented", "Inherited", "Not Applicable", "Manually Inherited"])
    ...
    def common_control_provider=(common_control_provider)
      validator = EnumAttributeValidator.new('String', ["DoD", "Component", "Enclave"])
    ...
    def control_designation=(control_designation)
      validator = EnumAttributeValidator.new('String', ["Common", "System-Specific", "Hybrid"])
    ...
    def slcm_frequency=(slcm_frequency)
      validator = EnumAttributeValidator.new('String', ["Constantly", "Daily", "Weekly", "Monthly", "Quarterly", "Semi-Annually", "Annually", "Every Two Years", "Every Three Years", "Undetermined"])
    ...
    def slcm_method=(slcm_method)
      validator = EnumAttributeValidator.new('String', ["Automated", "Semi-Automated", "Manual", "Undetermined"])
    ...
    def test_method=(test_method)
      validator = EnumAttributeValidator.new('String', ["Test", "Interview", "Examine", "Test, Interview", "Test, Examine", "Interview, Examine", "Test, Interview, Examine"])
