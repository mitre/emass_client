...
module EmassClient
  class StaticCodeApplication
    ...
    def valid?
      raw_severity_validator = EnumAttributeValidator.new('String', ["Low", "Medium", "Moderate", "High", "Critical"])
    ...
    def raw_severity=(raw_severity)
      validator = EnumAttributeValidator.new('String', ["Low", "Medium", "Moderate", "High", "Critical"])
