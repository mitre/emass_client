...
module EmassClient
  class SystemCriticalAssetsDashboardApi
    ...
    def get_system_critical_assets_summary(org_id, opts = {})
      data, _status_code, _headers = get_system_critical_assets_summary_with_http_info(org_id, opts)
      data
    end
    ...
    def get_system_critical_assets_summary_with_http_info(org_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SystemCriticalAssetsDashboardApi.get_system_critical_assets_summary ...'
      end
      # verify the required parameter 'org_id' is set
      if @api_client.config.client_side_validation && org_id.nil?
        fail ArgumentError, "Missing the required parameter 'org_id' when calling SystemCriticalAssetsDashboardApi.get_system_critical_assets_summary"
      end
      # resource path
      local_var_path = '/api/dashboards/system-critical-assets-summary'
      ...
      new_options = opts.merge(
        :operation => :"SystemCriticalAssetsDashboardApi.get_system_critical_assets_summary",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SystemCriticalAssetsDashboardApi#get_system_critical_assets_summary\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
