  ...
  class SystemPrivacyDashboardApi
    ...
    def get_system_privacy_summary_with_http_info(org_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SystemPrivacyDashboardApi.get_system_privacy_summary ...'
      end
      # verify the required parameter 'org_id' is set
      if @api_client.config.client_side_validation && org_id.nil?
        fail ArgumentError, "Missing the required parameter 'org_id' when calling SystemPrivacyDashboardApi.get_system_privacy_summary"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"SystemPrivacyDashboardApi.get_system_privacy_summary",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SystemPrivacyDashboardApi#get_system_privacy_summary\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
