  ...
  class EnterpriseArtifactsDashboardsApi
    ...
    def get_system_artifacts_details_with_http_info(org_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EnterpriseArtifactsDashboardsApi.get_system_artifacts_details ...'
      end
      # verify the required parameter 'org_id' is set
      if @api_client.config.client_side_validation && org_id.nil?
        fail ArgumentError, "Missing the required parameter 'org_id' when calling EnterpriseArtifactsDashboardsApi.get_system_artifacts_details"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"EnterpriseArtifactsDashboardsApi.get_system_artifacts_details",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EnterpriseArtifactsDashboardsApi#get_system_artifacts_details\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_system_artifacts_summary_with_http_info(org_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EnterpriseArtifactsDashboardsApi.get_system_artifacts_summary ...'
      end
      # verify the required parameter 'org_id' is set
      if @api_client.config.client_side_validation && org_id.nil?
        fail ArgumentError, "Missing the required parameter 'org_id' when calling EnterpriseArtifactsDashboardsApi.get_system_artifacts_summary"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"EnterpriseArtifactsDashboardsApi.get_system_artifacts_summary",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EnterpriseArtifactsDashboardsApi#get_system_artifacts_summary\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
