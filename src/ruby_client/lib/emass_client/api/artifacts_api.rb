...
module EmassClient
  class ArtifactsApi
    ...
    # @param system_id [Integer] **System Id**: The unique system record identifier.
    # @param [Hash] opts the optional parameters
    # @option opts [Array<DeleteArtifactsInner>] :delete_artifacts_inner Delete artifact files for the given System Id
    ...
    def delete_artifact_with_http_info(system_id, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'delete_artifacts_inner'])
