...
module EmassClient
  class ArtifactsApi
    ...
    def add_artifacts_by_system_id_with_http_info(system_id, zipper, opts = {})
      ...
      allowable_values = ["Procedure", "Diagram", "Policy", "Labor", "Document", "Image", "Other", "Scan Result", "Auditor Report"]
      if @api_client.config.client_side_validation && opts[:'type'] && !allowable_values.include?(opts[:'type'])
        fail ArgumentError, "invalid value for \"type\", must be one of #{allowable_values}"
      end
      allowable_values = ["Implementation Guidance", "Evidence"]
    ...
    # @param system_id [Integer] **System Id**: The unique system record identifier.
    # @param [Hash] opts the optional parameters
    # @option opts [Array<InlineObject2>] :inline_object2 Delete artifact files for the given System Id
    # @return [ArtifactsResponseDel]
    def delete_artifact(system_id, opts = {})
      data, _status_code, _headers = delete_artifact_with_http_info(system_id, opts)
      data
    end
    ...
    def delete_artifact_with_http_info(system_id, opts = {})
      if @api_client.config.debugging
