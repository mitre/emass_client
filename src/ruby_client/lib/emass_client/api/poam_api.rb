...
module EmassClient
  class POAMApi
    ...
    # @param system_id [Integer] **System Id**: The unique system record identifier.
    # @param inline_object [Array<InlineObject>] Delete the given POA&amp;M Id
    # @param [Hash] opts the optional parameters
    # @return [PoamResponseDelete]
    def delete_poam(system_id, inline_object, opts = {})
      data, _status_code, _headers = delete_poam_with_http_info(system_id, inline_object, opts)
      data
    end
    ...
    def delete_poam_with_http_info(system_id, inline_object, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && inline_object.nil?
        fail ArgumentError, "Missing the required parameter 'inline_object' when calling POAMApi.delete_poam"
      end
      # resource path
      local_var_path = '/api/systems/{systemId}/poams'.sub('{' + 'systemId' + '}', CGI.escape(system_id.to_s))
