...
module EmassClient
  class SystemFISMAMetricsDashboardApi
    ...
    def get_system_fisma_metrics(org_id, opts = {})
      data, _status_code, _headers = get_system_fisma_metrics_with_http_info(org_id, opts)
      data
    end
    ...
    def get_system_fisma_metrics_with_http_info(org_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SystemFISMAMetricsDashboardApi.get_system_fisma_metrics ...'
      end
      # verify the required parameter 'org_id' is set
      if @api_client.config.client_side_validation && org_id.nil?
        fail ArgumentError, "Missing the required parameter 'org_id' when calling SystemFISMAMetricsDashboardApi.get_system_fisma_metrics"
      end
      # resource path
      local_var_path = '/api/dashboards/system-fisma-metrics'
      ...
      new_options = opts.merge(
        :operation => :"SystemFISMAMetricsDashboardApi.get_system_fisma_metrics",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SystemFISMAMetricsDashboardApi#get_system_fisma_metrics\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
