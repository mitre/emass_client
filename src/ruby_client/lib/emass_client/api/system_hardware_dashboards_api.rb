  ...
  class SystemHardwareDashboardsApi
    ...
    def get_system_hardware_details_with_http_info(org_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SystemHardwareDashboardsApi.get_system_hardware_details ...'
      end
      # verify the required parameter 'org_id' is set
      if @api_client.config.client_side_validation && org_id.nil?
        fail ArgumentError, "Missing the required parameter 'org_id' when calling SystemHardwareDashboardsApi.get_system_hardware_details"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"SystemHardwareDashboardsApi.get_system_hardware_details",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SystemHardwareDashboardsApi#get_system_hardware_details\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_system_hardware_summary_with_http_info(org_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SystemHardwareDashboardsApi.get_system_hardware_summary ...'
      end
      # verify the required parameter 'org_id' is set
      if @api_client.config.client_side_validation && org_id.nil?
        fail ArgumentError, "Missing the required parameter 'org_id' when calling SystemHardwareDashboardsApi.get_system_hardware_summary"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"SystemHardwareDashboardsApi.get_system_hardware_summary",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SystemHardwareDashboardsApi#get_system_hardware_summary\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
