...
module EmassClient
  class SystemATCIATCDashboardApi
    ...
    def get_system_atc_iatc_details(org_id, opts = {})
      data, _status_code, _headers = get_system_atc_iatc_details_with_http_info(org_id, opts)
      data
    end
    ...
    def get_system_atc_iatc_details_with_http_info(org_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SystemATCIATCDashboardApi.get_system_atc_iatc_details ...'
      end
      # verify the required parameter 'org_id' is set
      if @api_client.config.client_side_validation && org_id.nil?
        fail ArgumentError, "Missing the required parameter 'org_id' when calling SystemATCIATCDashboardApi.get_system_atc_iatc_details"
      end
      # resource path
      local_var_path = '/api/dashboards/system-atc-iatc-details'
      ...
      new_options = opts.merge(
        :operation => :"SystemATCIATCDashboardApi.get_system_atc_iatc_details",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SystemATCIATCDashboardApi#get_system_atc_iatc_details\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
