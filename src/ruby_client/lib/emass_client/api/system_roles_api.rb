...
module EmassClient
  class SystemRolesApi
    ...
    def get_system_roles_by_category_id_with_http_info(role_category, role, opts = {})
      ...
      # verify enum value
      allowable_values = ["CAC", "PAC", "Other"]
      ...
      # verify enum value
      allowable_values = ["AO", "Auditor", "Artifact Manager", "C&A Team", "IAO", "ISSO", "PM/IAM", "SCA", "User Rep", "Validator"]
      ...
      allowable_values = ["diacap", "rmf", "reporting"]
