...
The `@mitre/emass_client@3.10.1` is a TypeScript/JavaScript client that utilizes [axios](https://github.com/axios/axios)
...
The `@mitre/emass_client@3.10.1 npm package` can be used in the following environments:
* Node.js
* Webpack
* Browserify
...
```
npm install @mitre/emass_client@3.10.1 --save
```
...
### Axios Configuration
All calls utilizing the @mitre/emass_client@3.10.1 need to initialize axios as follows:
