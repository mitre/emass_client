...
class TestPoamRequiredFields(unittest.TestCase):
    """PoamRequiredFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PoamRequiredFields:
        """Test PoamRequiredFields
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PoamRequiredFields`
        """
        model = PoamRequiredFields()
        if include_optional:
            return PoamRequiredFields(
                status = 'Completed',
    ...
    def testPoamRequiredFields(self):
        """Test PoamRequiredFields"""
