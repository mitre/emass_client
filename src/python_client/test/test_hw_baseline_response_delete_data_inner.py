...
class TestHwBaselineResponseDeleteDataInner(unittest.TestCase):
    """HwBaselineResponseDeleteDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HwBaselineResponseDeleteDataInner:
        """Test HwBaselineResponseDeleteDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HwBaselineResponseDeleteDataInner`
        """
        model = HwBaselineResponseDeleteDataInner()
        if include_optional:
            return HwBaselineResponseDeleteDataInner(
                system_id = 75,
    ...
    def testHwBaselineResponseDeleteDataInner(self):
        """Test HwBaselineResponseDeleteDataInner"""
