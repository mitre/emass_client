...
class TestControlsRequiredFields(unittest.TestCase):
    """ControlsRequiredFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlsRequiredFields:
        """Test ControlsRequiredFields
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlsRequiredFields`
        """
        model = ControlsRequiredFields()
        if include_optional:
            return ControlsRequiredFields(
                acronym = 'AC-3',
    ...
    def testControlsRequiredFields(self):
        """Test ControlsRequiredFields"""
