...
class TestGetSystemStatusDetails200Response(unittest.TestCase):
    """GetSystemStatusDetails200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSystemStatusDetails200Response:
        """Test GetSystemStatusDetails200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSystemStatusDetails200Response`
        """
        model = GetSystemStatusDetails200Response()
        if include_optional:
    ...
    def testGetSystemStatusDetails200Response(self):
        """Test GetSystemStatusDetails200Response"""
