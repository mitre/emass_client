...
class TestSwBaselineResponsePostPutDataInner(unittest.TestCase):
    """SwBaselineResponsePostPutDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwBaselineResponsePostPutDataInner:
        """Test SwBaselineResponsePostPutDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwBaselineResponsePostPutDataInner`
        """
        model = SwBaselineResponsePostPutDataInner()
        if include_optional:
            return SwBaselineResponsePostPutDataInner(
                system_id = 85,
    ...
    def testSwBaselineResponsePostPutDataInner(self):
        """Test SwBaselineResponsePostPutDataInner"""
