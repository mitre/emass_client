...
class TestSwBaselineResponseGetDataInner(unittest.TestCase):
    """SwBaselineResponseGetDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwBaselineResponseGetDataInner:
        """Test SwBaselineResponseGetDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwBaselineResponseGetDataInner`
        """
        model = SwBaselineResponseGetDataInner()
        if include_optional:
            return SwBaselineResponseGetDataInner(
                system_id = 85,
    ...
    def testSwBaselineResponseGetDataInner(self):
        """Test SwBaselineResponseGetDataInner"""
