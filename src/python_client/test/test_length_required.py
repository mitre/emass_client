...
class TestLengthRequired(unittest.TestCase):
    """LengthRequired unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LengthRequired:
        """Test LengthRequired
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LengthRequired`
        """
        model = LengthRequired()
        if include_optional:
            return LengthRequired(
                meta = emass_client.models.length_required_meta.Length_Required_meta(
                    code = 411, 
