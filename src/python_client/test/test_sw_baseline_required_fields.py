...
class TestSwBaselineRequiredFields(unittest.TestCase):
    """SwBaselineRequiredFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwBaselineRequiredFields:
        """Test SwBaselineRequiredFields
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwBaselineRequiredFields`
        """
        model = SwBaselineRequiredFields()
        if include_optional:
            return SwBaselineRequiredFields(
    ...
    def testSwBaselineRequiredFields(self):
        """Test SwBaselineRequiredFields"""
