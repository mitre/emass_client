...
class TestForbiddenMeta(unittest.TestCase):
    """ForbiddenMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForbiddenMeta:
        """Test ForbiddenMeta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForbiddenMeta`
        """
        model = ForbiddenMeta()
        if include_optional:
