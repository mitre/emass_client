...
class TestControlsReadOnlyFields(unittest.TestCase):
    """ControlsReadOnlyFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlsReadOnlyFields:
        """Test ControlsReadOnlyFields
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlsReadOnlyFields`
        """
        model = ControlsReadOnlyFields()
        if include_optional:
            return ControlsReadOnlyFields(
                name = 'System XYZ',
                ccis = '000001,000002',
                is_inherited = True,
    ...
    def testControlsReadOnlyFields(self):
        """Test ControlsReadOnlyFields"""
