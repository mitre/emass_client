...
class TestHwBaselineResponsePostPutDataInner(unittest.TestCase):
    """HwBaselineResponsePostPutDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HwBaselineResponsePostPutDataInner:
        """Test HwBaselineResponsePostPutDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HwBaselineResponsePostPutDataInner`
        """
        model = HwBaselineResponsePostPutDataInner()
        if include_optional:
            return HwBaselineResponsePostPutDataInner(
                system_id = 75,
    ...
    def testHwBaselineResponsePostPutDataInner(self):
        """Test HwBaselineResponsePostPutDataInner"""
