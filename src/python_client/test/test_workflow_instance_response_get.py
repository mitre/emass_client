...
class TestWorkflowInstanceResponseGet(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WorkflowInstanceResponseGet:
        ...
        """
        model = WorkflowInstanceResponseGet()
        if include_optional:
            return WorkflowInstanceResponseGet(
                meta = emass_client.models.ok.OK(
                    code = 200, ),
                data = emass_client.models.workflow_instances___return_query_for_the_get_workflow_instances_in_a_site.Workflow Instances - return query for the GET workflow instances in a site(
