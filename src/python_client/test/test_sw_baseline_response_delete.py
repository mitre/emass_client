...
class TestSwBaselineResponseDelete(unittest.TestCase):
    """SwBaselineResponseDelete unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwBaselineResponseDelete:
        """Test SwBaselineResponseDelete
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwBaselineResponseDelete`
        """
        model = SwBaselineResponseDelete()
        if include_optional:
            return SwBaselineResponseDelete(
                meta = emass_client.models.ok.OK(
                    code = 200, ),
                data = [
                    emass_client.models.sw_baseline_response_delete_data_inner.SwBaselineResponseDelete_data_inner(
                        system_id = 85, 
    ...
    def testSwBaselineResponseDelete(self):
        """Test SwBaselineResponseDelete"""
