...
class TestPoamReadOnlyFields(unittest.TestCase):
    """PoamReadOnlyFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PoamReadOnlyFields:
        """Test PoamReadOnlyFields
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PoamReadOnlyFields`
        """
        model = PoamReadOnlyFields()
        if include_optional:
            return PoamReadOnlyFields(
    ...
    def testPoamReadOnlyFields(self):
        """Test PoamReadOnlyFields"""
