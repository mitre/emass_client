...
class TestHwBaselineRequiredFields(unittest.TestCase):
    """HwBaselineRequiredFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HwBaselineRequiredFields:
        """Test HwBaselineRequiredFields
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HwBaselineRequiredFields`
        """
        model = HwBaselineRequiredFields()
        if include_optional:
            return HwBaselineRequiredFields(
    ...
    def testHwBaselineRequiredFields(self):
        """Test HwBaselineRequiredFields"""
