...
class TestMethodNotAllowed(unittest.TestCase):
    """MethodNotAllowed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MethodNotAllowed:
        """Test MethodNotAllowed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MethodNotAllowed`
        """
        model = MethodNotAllowed()
        if include_optional:
            return MethodNotAllowed(
                meta = emass_client.models.method_not_allowed_meta.Method_Not_Allowed_meta(
                    code = 405, 
