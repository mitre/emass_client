...
class TestSystemPortsProtocolsDashboardsApi(unittest.TestCase):
    """SystemPortsProtocolsDashboardsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SystemPortsProtocolsDashboardsApi()
