...
class TestSystemSensorHardwareDashboardsApi(unittest.TestCase):
    """SystemSensorHardwareDashboardsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SystemSensorHardwareDashboardsApi()
