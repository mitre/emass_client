...
import emass_client
from emass_client.paths.api_systems_system_id_static_code_scans import post  # noqa: E501
from emass_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiSystemsSystemIdStaticCodeScans(ApiTestMixin, unittest.TestCase):
    """
    ApiSystemsSystemIdStaticCodeScans unit test stubs
