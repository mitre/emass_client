...
import emass_client
from emass_client.paths.api_systems_system_id_cloud_resource_results import post  # noqa: E501
from emass_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiSystemsSystemIdCloudResourceResults(ApiTestMixin, unittest.TestCase):
    """
    ApiSystemsSystemIdCloudResourceResults unit test stubs
