...
import emass_client
from emass_client.paths.api_dashboards_system_artifacts_summary import get  # noqa: E501
from emass_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiDashboardsSystemArtifactsSummary(ApiTestMixin, unittest.TestCase):
    """
    ApiDashboardsSystemArtifactsSummary unit test stubs
