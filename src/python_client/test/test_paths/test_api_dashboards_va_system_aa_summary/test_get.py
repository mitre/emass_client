...
import emass_client
from emass_client.paths.api_dashboards_va_system_aa_summary import get  # noqa: E501
from emass_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiDashboardsVaSystemAaSummary(ApiTestMixin, unittest.TestCase):
    """
    ApiDashboardsVaSystemAaSummary unit test stubs
