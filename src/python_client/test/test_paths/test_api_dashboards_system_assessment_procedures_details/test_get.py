...
import emass_client
from emass_client.paths.api_dashboards_system_assessment_procedures_details import get  # noqa: E501
from emass_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiDashboardsSystemAssessmentProceduresDetails(ApiTestMixin, unittest.TestCase):
    """
    ApiDashboardsSystemAssessmentProceduresDetails unit test stubs
