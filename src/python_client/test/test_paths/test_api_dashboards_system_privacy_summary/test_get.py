...
import emass_client
from emass_client.paths.api_dashboards_system_privacy_summary import get  # noqa: E501
from emass_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiDashboardsSystemPrivacySummary(ApiTestMixin, unittest.TestCase):
    """
    ApiDashboardsSystemPrivacySummary unit test stubs
