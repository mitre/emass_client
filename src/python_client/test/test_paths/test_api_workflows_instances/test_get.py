...
import emass_client
from emass_client.paths.api_workflows_instances import get  # noqa: E501
from emass_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiWorkflowsInstances(ApiTestMixin, unittest.TestCase):
    """
    ApiWorkflowsInstances unit test stubs
