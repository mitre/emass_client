...
import emass_client
from emass_client.paths.api_dashboards_va_system_a2_summary import get  # noqa: E501
from emass_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiDashboardsVaSystemA2Summary(ApiTestMixin, unittest.TestCase):
    """
    ApiDashboardsVaSystemA2Summary unit test stubs
