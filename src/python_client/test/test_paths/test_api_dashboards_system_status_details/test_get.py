...
import emass_client
from emass_client.paths.api_dashboards_system_status_details import get  # noqa: E501
from emass_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiDashboardsSystemStatusDetails(ApiTestMixin, unittest.TestCase):
    """
    ApiDashboardsSystemStatusDetails unit test stubs
