...
import emass_client
from emass_client.paths.api_dashboards_va_system_threat_architecture_details import get  # noqa: E501
from emass_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiDashboardsVaSystemThreatArchitectureDetails(ApiTestMixin, unittest.TestCase):
    """
    ApiDashboardsVaSystemThreatArchitectureDetails unit test stubs
