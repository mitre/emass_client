...
import emass_client
from emass_client.paths.api_dashboards_system_poam_details import get  # noqa: E501
from emass_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiDashboardsSystemPoamDetails(ApiTestMixin, unittest.TestCase):
    """
    ApiDashboardsSystemPoamDetails unit test stubs
