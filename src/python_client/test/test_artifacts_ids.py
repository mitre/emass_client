...
class TestArtifactsIds(unittest.TestCase):
    """ArtifactsIds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArtifactsIds:
        """Test ArtifactsIds
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtifactsIds`
        """
        model = ArtifactsIds()
        if include_optional:
            return ArtifactsIds(
