...
class TestSwBaselineResponseGet(unittest.TestCase):
    """SwBaselineResponseGet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwBaselineResponseGet:
        """Test SwBaselineResponseGet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwBaselineResponseGet`
        """
        model = SwBaselineResponseGet()
        if include_optional:
    ...
    def testSwBaselineResponseGet(self):
        """Test SwBaselineResponseGet"""
