# emass_client.SystemStatusDashboardApi

All URIs are relative to *http://localhost:4010*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_system_status_details**](SystemStatusDashboardApi.md#get_system_status_details) | **GET** /api/dashboards/system-status-details | System Status Details


# **get_system_status_details**
> GetSystemStatusDetails200Response get_system_status_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.SystemStatusDashboardApi(api_client)
    ...
    try:
        ...
        print("The response of SystemStatusDashboardApi->get_system_status_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemStatusDashboardApi->get_system_status_details: %s\n" % e)
```
