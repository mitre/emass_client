# emass_client.SystemPortsProtocolsDashboardsApi
...
> GetSystemStatusDetails200Response get_system_ports_protocols_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.SystemPortsProtocolsDashboardsApi(api_client)
    ...
    try:
        ...
        print("The response of SystemPortsProtocolsDashboardsApi->get_system_ports_protocols_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemPortsProtocolsDashboardsApi->get_system_ports_protocols_details: %s\n" % e)
```
...
> GetSystemStatusDetails200Response get_system_ports_protocols_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SystemPortsProtocolsDashboardsApi->get_system_ports_protocols_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemPortsProtocolsDashboardsApi->get_system_ports_protocols_summary: %s\n" % e)
```
