# emass_client.SystemAASummaryDashboardApi
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.SystemAASummaryDashboardApi(api_client)
    ...
    try:
        ...
        print("The response of SystemAASummaryDashboardApi->get_va_system_aa_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemAASummaryDashboardApi->get_va_system_aa_summary: %s\n" % e)
```
