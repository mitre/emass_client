# emass_client.EnterpriseSensorBasedSoftwareResourcesDashboardsApi
...
> object get_system_sensor_software_counts(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.EnterpriseSensorBasedSoftwareResourcesDashboardsApi(api_client)
    ...
    try:
        # System Sensor Software Counts
        api_response = api_instance.get_system_sensor_software_counts(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
        print("The response of EnterpriseSensorBasedSoftwareResourcesDashboardsApi->get_system_sensor_software_counts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EnterpriseSensorBasedSoftwareResourcesDashboardsApi->get_system_sensor_software_counts: %s\n" % e)
```
...
> object get_system_sensor_software_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    try:
        # System Sensor Software Details
        api_response = api_instance.get_system_sensor_software_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
        print("The response of EnterpriseSensorBasedSoftwareResourcesDashboardsApi->get_system_sensor_software_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EnterpriseSensorBasedSoftwareResourcesDashboardsApi->get_system_sensor_software_details: %s\n" % e)
```
...
> object get_system_sensor_software_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    try:
        # System Sensor Software Summary
        api_response = api_instance.get_system_sensor_software_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
        print("The response of EnterpriseSensorBasedSoftwareResourcesDashboardsApi->get_system_sensor_software_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EnterpriseSensorBasedSoftwareResourcesDashboardsApi->get_system_sensor_software_summary: %s\n" % e)
```
