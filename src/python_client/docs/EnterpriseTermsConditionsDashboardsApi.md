# emass_client.EnterpriseTermsConditionsDashboardsApi
...
> object get_system_terms_conditions_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.EnterpriseTermsConditionsDashboardsApi(api_client)
    ...
    try:
        ...
        print("The response of EnterpriseTermsConditionsDashboardsApi->get_system_terms_conditions_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EnterpriseTermsConditionsDashboardsApi->get_system_terms_conditions_details: %s\n" % e)
```
...
> object get_system_terms_conditions_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EnterpriseTermsConditionsDashboardsApi->get_system_terms_conditions_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EnterpriseTermsConditionsDashboardsApi->get_system_terms_conditions_summary: %s\n" % e)
```
