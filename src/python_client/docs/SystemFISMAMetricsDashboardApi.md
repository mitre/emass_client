# emass_client.SystemFISMAMetricsDashboardApi
...
> GetSystemStatusDetails200Response get_system_fisma_metrics(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.SystemFISMAMetricsDashboardApi(api_client)
    ...
    try:
        # System FISMA Metrics
        api_response = api_instance.get_system_fisma_metrics(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
        print("The response of SystemFISMAMetricsDashboardApi->get_system_fisma_metrics:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemFISMAMetricsDashboardApi->get_system_fisma_metrics: %s\n" % e)
```
