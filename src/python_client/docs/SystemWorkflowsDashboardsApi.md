# emass_client.SystemWorkflowsDashboardsApi
...
> GetSystemStatusDetails200Response get_system_workflows_history_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.SystemWorkflowsDashboardsApi(api_client)
    ...
    try:
        # System Workflows History Details
        api_response = api_instance.get_system_workflows_history_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
        print("The response of SystemWorkflowsDashboardsApi->get_system_workflows_history_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemWorkflowsDashboardsApi->get_system_workflows_history_details: %s\n" % e)
```
...
> GetSystemStatusDetails200Response get_system_workflows_history_stage_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    try:
        # System Workflows History Stage Details
        api_response = api_instance.get_system_workflows_history_stage_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
        print("The response of SystemWorkflowsDashboardsApi->get_system_workflows_history_stage_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemWorkflowsDashboardsApi->get_system_workflows_history_stage_details: %s\n" % e)
```
...
> GetSystemStatusDetails200Response get_system_workflows_history_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    try:
        # System Workflows History Summary
        api_response = api_instance.get_system_workflows_history_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
        print("The response of SystemWorkflowsDashboardsApi->get_system_workflows_history_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemWorkflowsDashboardsApi->get_system_workflows_history_summary: %s\n" % e)
```
