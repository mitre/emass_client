# emass_client.SystemConnectivityCCSDDashboardsApi
...
> GetSystemStatusDetails200Response get_system_connectivity_ccsd_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.SystemConnectivityCCSDDashboardsApi(api_client)
    ...
    try:
        # System Connectivity/CCSD Details
        api_response = api_instance.get_system_connectivity_ccsd_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
        print("The response of SystemConnectivityCCSDDashboardsApi->get_system_connectivity_ccsd_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemConnectivityCCSDDashboardsApi->get_system_connectivity_ccsd_details: %s\n" % e)
```
...
> GetSystemStatusDetails200Response get_system_connectivity_ccsd_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    try:
        # System Connectivity/CCSD Summary
        api_response = api_instance.get_system_connectivity_ccsd_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
        print("The response of SystemConnectivityCCSDDashboardsApi->get_system_connectivity_ccsd_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemConnectivityCCSDDashboardsApi->get_system_connectivity_ccsd_summary: %s\n" % e)
```
