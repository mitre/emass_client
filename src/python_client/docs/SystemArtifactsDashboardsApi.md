# emass_client.SystemArtifactsDashboardsApi
...
> GetSystemStatusDetails200Response get_system_artifacts_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.SystemArtifactsDashboardsApi(api_client)
    ...
    try:
        ...
        print("The response of SystemArtifactsDashboardsApi->get_system_artifacts_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemArtifactsDashboardsApi->get_system_artifacts_details: %s\n" % e)
```
...
> GetSystemStatusDetails200Response get_system_artifacts_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SystemArtifactsDashboardsApi->get_system_artifacts_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemArtifactsDashboardsApi->get_system_artifacts_summary: %s\n" % e)
```
