# emass_client.SystemPL109ReportingSummaryDashboardApi
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.SystemPL109ReportingSummaryDashboardApi(api_client)
    ...
    try:
        ...
        print("The response of SystemPL109ReportingSummaryDashboardApi->get_va_system_pl109_reporting_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemPL109ReportingSummaryDashboardApi->get_va_system_pl109_reporting_summary: %s\n" % e)
```
