# emass_client.SystemPOAMDashboardsApi
...
> GetSystemStatusDetails200Response get_system_poam_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.SystemPOAMDashboardsApi(api_client)
    ...
    try:
        ...
        print("The response of SystemPOAMDashboardsApi->get_system_poam_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemPOAMDashboardsApi->get_system_poam_details: %s\n" % e)
```
...
> GetSystemStatusDetails200Response get_system_poam_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SystemPOAMDashboardsApi->get_system_poam_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemPOAMDashboardsApi->get_system_poam_summary: %s\n" % e)
```
