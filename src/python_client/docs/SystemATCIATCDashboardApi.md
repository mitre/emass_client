# emass_client.SystemATCIATCDashboardApi
...
> GetSystemStatusDetails200Response get_system_atc_iatc_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.SystemATCIATCDashboardApi(api_client)
    ...
    try:
        # System ATC/IATC Details
        api_response = api_instance.get_system_atc_iatc_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
        print("The response of SystemATCIATCDashboardApi->get_system_atc_iatc_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemATCIATCDashboardApi->get_system_atc_iatc_details: %s\n" % e)
```
