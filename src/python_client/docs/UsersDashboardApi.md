# emass_client.UsersDashboardApi
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.UsersDashboardApi(api_client)
    ...
    try:
        ...
        print("The response of UsersDashboardApi->get_user_system_assignments_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersDashboardApi->get_user_system_assignments_details: %s\n" % e)
```
