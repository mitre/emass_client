# emass_client.SystemSensorSoftwareDashboardsApi
...
> GetSystemStatusDetails200Response get_system_sensor_software_counts(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.SystemSensorSoftwareDashboardsApi(api_client)
    ...
    try:
        ...
        print("The response of SystemSensorSoftwareDashboardsApi->get_system_sensor_software_counts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemSensorSoftwareDashboardsApi->get_system_sensor_software_counts: %s\n" % e)
```
...
> GetSystemStatusDetails200Response get_system_sensor_software_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SystemSensorSoftwareDashboardsApi->get_system_sensor_software_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemSensorSoftwareDashboardsApi->get_system_sensor_software_details: %s\n" % e)
```
...
> GetSystemStatusDetails200Response get_system_sensor_software_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SystemSensorSoftwareDashboardsApi->get_system_sensor_software_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemSensorSoftwareDashboardsApi->get_system_sensor_software_summary: %s\n" % e)
```
