# emass_client.SystemSensorHardwareDashboardsApi
...
> GetSystemStatusDetails200Response get_system_sensor_hardware_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.SystemSensorHardwareDashboardsApi(api_client)
    ...
    try:
        ...
        print("The response of SystemSensorHardwareDashboardsApi->get_system_sensor_hardware_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemSensorHardwareDashboardsApi->get_system_sensor_hardware_details: %s\n" % e)
```
...
> GetSystemStatusDetails200Response get_system_sensor_hardware_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SystemSensorHardwareDashboardsApi->get_system_sensor_hardware_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemSensorHardwareDashboardsApi->get_system_sensor_hardware_summary: %s\n" % e)
```
