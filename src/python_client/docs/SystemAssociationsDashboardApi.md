# emass_client.SystemAssociationsDashboardApi
...
> GetSystemStatusDetails200Response get_system_associations_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.SystemAssociationsDashboardApi(api_client)
    ...
    try:
        ...
        print("The response of SystemAssociationsDashboardApi->get_system_associations_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemAssociationsDashboardApi->get_system_associations_details: %s\n" % e)
```
