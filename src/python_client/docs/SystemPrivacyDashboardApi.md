# emass_client.SystemPrivacyDashboardApi
...
> GetSystemStatusDetails200Response get_system_privacy_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.SystemPrivacyDashboardApi(api_client)
    ...
    try:
        ...
        print("The response of SystemPrivacyDashboardApi->get_system_privacy_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemPrivacyDashboardApi->get_system_privacy_summary: %s\n" % e)
```
