# emass_client.VAOMBFISMADashboardApi
...
> GetSystemStatusDetails200Response get_va_omb_fsma_saop_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.VAOMBFISMADashboardApi(api_client)
    ...
    try:
        ...
        print("The response of VAOMBFISMADashboardApi->get_va_omb_fsma_saop_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VAOMBFISMADashboardApi->get_va_omb_fsma_saop_summary: %s\n" % e)
```
