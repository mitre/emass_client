# emass_client.SystemTermsConditionsDashboardsApi
...
> GetSystemStatusDetails200Response get_system_terms_conditions_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.SystemTermsConditionsDashboardsApi(api_client)
    ...
    try:
        # System Terms Conditions Details
        api_response = api_instance.get_system_terms_conditions_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
        print("The response of SystemTermsConditionsDashboardsApi->get_system_terms_conditions_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemTermsConditionsDashboardsApi->get_system_terms_conditions_details: %s\n" % e)
```
...
> GetSystemStatusDetails200Response get_system_terms_conditions_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    try:
        # System Terms Conditions Summary
        api_response = api_instance.get_system_terms_conditions_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
        print("The response of SystemTermsConditionsDashboardsApi->get_system_terms_conditions_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemTermsConditionsDashboardsApi->get_system_terms_conditions_summary: %s\n" % e)
```
