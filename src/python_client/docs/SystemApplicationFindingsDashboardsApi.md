# emass_client.SystemApplicationFindingsDashboardsApi
...
> GetSystemStatusDetails200Response get_system_application_findings_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    api_instance = emass_client.SystemApplicationFindingsDashboardsApi(api_client)
    ...
    try:
        # System Application Findings Details
        api_response = api_instance.get_system_application_findings_details(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
        print("The response of SystemApplicationFindingsDashboardsApi->get_system_application_findings_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemApplicationFindingsDashboardsApi->get_system_application_findings_details: %s\n" % e)
```
...
> GetSystemStatusDetails200Response get_system_application_findings_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
...
with emass_client.ApiClient(configuration) as api_client:
    ...
    try:
        # System Application Findings Summary
        api_response = api_instance.get_system_application_findings_summary(org_id, excludeinherited=excludeinherited, page_index=page_index, page_size=page_size)
        print("The response of SystemApplicationFindingsDashboardsApi->get_system_application_findings_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemApplicationFindingsDashboardsApi->get_system_application_findings_summary: %s\n" % e)
```
