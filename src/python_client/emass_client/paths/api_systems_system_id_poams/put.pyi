...
# body param
SchemaForRequestBodyApplicationJson = PoamRequestPutBody


request_body_poam_request_put_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PoamResponsePut
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_poam_by_system_id_oapg(
        self,
    ...
    def _update_poam_by_system_id_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_poam_request_put_body.serialize(body, content_type)
...
class UpdatePoamBySystemId(BaseApi):
    ...
    def update_poam_by_system_id(
        ...
        return self._update_poam_by_system_id_oapg(
            body=body,
