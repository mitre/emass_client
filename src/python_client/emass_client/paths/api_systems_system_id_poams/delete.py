...
# body param
SchemaForRequestBodyApplicationJson = PoamRequestDeleteBody


request_body_poam_request_delete_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PoamResponseDelete
...
class BaseApi(api_client.Api):
    ...
    def _delete_poam_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_poam_request_delete_body.serialize(body, content_type)
