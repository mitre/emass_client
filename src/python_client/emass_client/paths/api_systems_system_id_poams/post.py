...
# body param
SchemaForRequestBodyApplicationJson = PoamRequestPostBody


request_body_poam_request_post_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PoamResponsePost
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_poam_by_system_id_oapg(
        self,
    ...
    def _add_poam_by_system_id_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_poam_request_post_body.serialize(body, content_type)
...
class AddPoamBySystemId(BaseApi):
    ...
    def add_poam_by_system_id(
        ...
        return self._add_poam_by_system_id_oapg(
            body=body,
