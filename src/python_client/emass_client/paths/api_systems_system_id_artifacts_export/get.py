...
CompressSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'compress': typing.Union[CompressSchema, bool, ],
    },
    total=False
)
...
request_query_compress = api_client.QueryParameter(
    name="compress",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_system_artifacts_export_oapg(
        self,
...
class GetSystemArtifactsExport(BaseApi):
    ...
    def get_system_artifacts_export(
        ...
        return self._get_system_artifacts_export_oapg(
