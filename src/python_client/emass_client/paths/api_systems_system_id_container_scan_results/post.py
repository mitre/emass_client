...
# body param
SchemaForRequestBodyApplicationJson = ContainersRequestPostBody


request_body_containers_request_post_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ContainersResponsePost
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_container_sans_by_system_id_oapg(
        self,
    ...
    def _add_container_sans_by_system_id_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_containers_request_post_body.serialize(body, content_type)
...
class AddContainerSansBySystemId(BaseApi):
    ...
    def add_container_sans_by_system_id(
        ...
        return self._add_container_sans_by_system_id_oapg(
            body=body,
