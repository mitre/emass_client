...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_system_sensor_hardware_details_oapg(
        self,
...
class GetSystemSensorHardwareDetails(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_system_sensor_hardware_details(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_system_sensor_hardware_details(
        ...
        return self._get_system_sensor_hardware_details_oapg(
