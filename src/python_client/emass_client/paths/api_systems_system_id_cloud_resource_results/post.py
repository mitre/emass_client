...
# body param
SchemaForRequestBodyApplicationJson = CloudResourcesRequestPostBody


request_body_cloud_resources_request_post_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CloudResourcesResponsePost
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_cloud_resources_by_system_id_oapg(
        self,
    ...
    def _add_cloud_resources_by_system_id_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_cloud_resources_request_post_body.serialize(body, content_type)
...
class AddCloudResourcesBySystemId(BaseApi):
    ...
    def add_cloud_resources_by_system_id(
        ...
        return self._add_cloud_resources_by_system_id_oapg(
            body=body,
