...
# body param
SchemaForRequestBodyApplicationJson = ControlsRequestPutBody


request_body_controls_request_put_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ControlsResponsePut
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_control_by_system_id_oapg(
        self,
    ...
    def _update_control_by_system_id_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_controls_request_put_body.serialize(body, content_type)
...
class UpdateControlBySystemId(BaseApi):
    ...
    def update_control_by_system_id(
        ...
        return self._update_control_by_system_id_oapg(
            body=body,
