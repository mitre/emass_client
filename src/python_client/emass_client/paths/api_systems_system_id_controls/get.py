...
# Query params
AcronymsSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'acronyms': typing.Union[AcronymsSchema, str, ],
    },
    total=False
)
...
request_query_acronyms = api_client.QueryParameter(
    name="acronyms",
    style=api_client.ParameterStyle.FORM,
    schema=AcronymsSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = ControlsResponseGet
...
class GetSystemControls(BaseApi):
    ...
    def get_system_controls(
        ...
        return self._get_system_controls_oapg(
