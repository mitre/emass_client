...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_va_system_fisma_invetory_crypto_summary_oapg(
        self,
...
class GetVaSystemFismaInvetoryCryptoSummary(BaseApi):
    ...
    def get_va_system_fisma_invetory_crypto_summary(
        ...
        return self._get_va_system_fisma_invetory_crypto_summary_oapg(
