...
# Path params
WorkflowInstanceIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'workflowInstanceId': typing.Union[WorkflowInstanceIdSchema, decimal.Decimal, int, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = WorkflowInstanceResponseGet
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_system_workflow_instances_by_workflow_instance_id_oapg(
        self,
...
class GetSystemWorkflowInstancesByWorkflowInstanceId(BaseApi):
    ...
    def get_system_workflow_instances_by_workflow_instance_id(
        ...
        return self._get_system_workflow_instances_by_workflow_instance_id_oapg(
