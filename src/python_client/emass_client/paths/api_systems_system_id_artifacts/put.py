...
# body param
SchemaForRequestBodyApplicationJson = ArtifactsRequestPutBody


request_body_artifacts_request_put_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_artifact_by_system_id_oapg(
        self,
    ...
    def _update_artifact_by_system_id_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_artifacts_request_put_body.serialize(body, content_type)
...
class UpdateArtifactBySystemId(BaseApi):
    ...
    def update_artifact_by_system_id(
        ...
        return self._update_artifact_by_system_id_oapg(
            body=body,
