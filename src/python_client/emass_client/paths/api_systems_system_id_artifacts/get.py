...
SchemaFor200ResponseBodyApplicationJson = ArtifactsResponseGet
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_system_artifacts_oapg(
        self,
...
class GetSystemArtifacts(BaseApi):
    ...
    def get_system_artifacts(
        ...
        return self._get_system_artifacts_oapg(
