...
# Query params
IsBulkSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'isBulk': typing.Union[IsBulkSchema, bool, ],
    },
    total=False
)
...
request_query_is_bulk = api_client.QueryParameter(
    name="isBulk",
...
class SchemaForRequestBodyMultipartFormData(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                @schemas.classproperty
                def SCAN_RESULT(cls):
                    return cls("Scan Result")
                
                @schemas.classproperty
                def AUDITOR_REPORT(cls):
                    return cls("Auditor Report")
            ...
            class category(
                ...
                @schemas.classproperty
                def IMPLEMENTATION_GUIDANCE(cls):
                    return cls("Implementation Guidance")
                
                @schemas.classproperty
                def EVIDENCE(cls):
                    return cls("Evidence")
            Zipper = schemas.BinarySchema
            __annotations__ = {
    ...
    Zipper: MetaOapg.properties.Zipper
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Zipper"]) -> MetaOapg.properties.Zipper: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["isTemplate", "type", "category", "Zipper", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Zipper"]) -> MetaOapg.properties.Zipper: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["isTemplate", "type", "category", "Zipper", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        Zipper: typing.Union[MetaOapg.properties.Zipper, bytes, io.FileIO, io.BufferedReader, ],
        isTemplate: typing.Union[MetaOapg.properties.isTemplate, bool, schemas.Unset] = schemas.unset,
...
SchemaFor200ResponseBodyApplicationJson = ArtifactsResponsePutPost
...
SchemaFor201ResponseBodyApplicationJson = Response201
...
SchemaFor411ResponseBodyApplicationJson = Response411


@dataclass
class ApiResponseFor411(api_client.ApiResponse):
    response: urllib3.HTTPResponse
    body: typing.Union[
...
_response_for_411 = api_client.OpenApiResponse(
    response_cls=ApiResponseFor411,
    content={
        'application/json': api_client.MediaType(
            schema=SchemaFor411ResponseBodyApplicationJson),
    },
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_artifacts_by_system_id_oapg(
        self,
...
class AddArtifactsBySystemId(BaseApi):
    ...
    def add_artifacts_by_system_id(
        ...
        return self._add_artifacts_by_system_id_oapg(
            body=body,
