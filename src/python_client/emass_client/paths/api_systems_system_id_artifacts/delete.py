...
# body param
SchemaForRequestBodyApplicationJson = ArtifactsRequestDeleteBody


request_body_artifacts_request_delete_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ArtifactsResponseDel
...
class BaseApi(api_client.Api):
    ...
    def _delete_artifact_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_artifacts_request_delete_body.serialize(body, content_type)
