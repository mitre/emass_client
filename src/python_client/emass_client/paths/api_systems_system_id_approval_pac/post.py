...
# body param
SchemaForRequestBodyApplicationJson = PacRequestPostBody


request_body_pac_request_post_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PacResponsePost
...
class BaseApi(api_client.Api):
    ...
    def _add_system_pac_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_pac_request_post_body.serialize(body, content_type)
...
class AddSystemPac(BaseApi):
    ...
    def add_system_pac(
        ...
        return self._add_system_pac_oapg(
            body=body,
