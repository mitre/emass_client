...
# Query params
OrgIdSchema = schemas.IntSchema
ExcludeinheritedSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'excludeinherited': typing.Union[ExcludeinheritedSchema, bool, ],
...
request_query_excludeinherited = api_client.QueryParameter(
    name="excludeinherited",
    style=api_client.ParameterStyle.FORM,
    schema=ExcludeinheritedSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_va_system_threat_architecture_details_oapg(
        self,
    ...
    def _get_va_system_threat_architecture_details_oapg(
        ...
        for parameter in (
            ...
            request_query_excludeinherited,
...
class GetVaSystemThreatArchitectureDetails(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_va_system_threat_architecture_details(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_va_system_threat_architecture_details(
        ...
        return self._get_va_system_threat_architecture_details_oapg(
