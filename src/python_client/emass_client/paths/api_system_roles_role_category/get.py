...
class RoleSchema(
    ...
    @schemas.classproperty
    def ARTIFACT_MANAGER(cls):
        return cls("Artifact Manager")
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'roleCategory': typing.Union[RoleCategorySchema, str, ],
    }
)
...
request_path_role_category = api_client.PathParameter(
    name="roleCategory",
    style=api_client.ParameterStyle.SIMPLE,
    schema=RoleCategorySchema,
    required=True,
)
_auth = [
    'apiKey',
...
SchemaFor200ResponseBodyApplicationJson = SystemRolesCategoryResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_system_roles_by_category_id_oapg(
        self,
...
class GetSystemRolesByCategoryId(BaseApi):
    ...
    def get_system_roles_by_category_id(
        ...
        return self._get_system_roles_by_category_id_oapg(
