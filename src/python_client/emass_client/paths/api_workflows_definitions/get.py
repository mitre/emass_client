...
SchemaFor200ResponseBodyApplicationJson = WorkflowDefinitionResponseGet
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_workflow_definitions_oapg(
        self,
...
class GetWorkflowDefinitions(BaseApi):
    ...
    def get_workflow_definitions(
        ...
        return self._get_workflow_definitions_oapg(
