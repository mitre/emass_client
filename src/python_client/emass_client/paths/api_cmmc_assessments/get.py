...
SchemaFor200ResponseBodyApplicationJson = CmmcResponseGet
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_cmmc_assessments_oapg(
        self,
...
class GetCmmcAssessments(BaseApi):
    ...
    def get_cmmc_assessments(
        ...
        return self._get_cmmc_assessments_oapg(
