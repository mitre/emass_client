...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'milestoneId': typing.Union[MilestoneIdSchema, decimal.Decimal, int, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = MilestoneResponseGetMilestone
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_system_milestones_by_poam_id_and_milestone_id_oapg(
        self,
...
class GetSystemMilestonesByPoamIdAndMilestoneId(BaseApi):
    ...
    def get_system_milestones_by_poam_id_and_milestone_id(
        ...
        return self._get_system_milestones_by_poam_id_and_milestone_id_oapg(
