...
PoamIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'systemId': typing.Union[SystemIdSchema, decimal.Decimal, int, ],
        'poamId': typing.Union[PoamIdSchema, decimal.Decimal, int, ],
    }
)
...
request_path_poam_id = api_client.PathParameter(
    name="poamId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PoamIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = MilestoneResponseGet
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_system_milestones_by_poam_id_oapg(
        self,
...
class GetSystemMilestonesByPoamId(BaseApi):
    ...
    def get_system_milestones_by_poam_id(
        ...
        return self._get_system_milestones_by_poam_id_oapg(
