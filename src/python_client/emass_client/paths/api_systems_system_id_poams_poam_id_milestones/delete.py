...
# body param
SchemaForRequestBodyApplicationJson = MilestonesRequestDeleteBody


request_body_milestones_request_delete_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = MilestonesPutPostDelete
...
class BaseApi(api_client.Api):
    ...
    def _delete_milestone_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_milestones_request_delete_body.serialize(body, content_type)
