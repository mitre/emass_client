...
# body param
SchemaForRequestBodyApplicationJson = MilestonesRequestPutBody


request_body_milestones_request_put_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = MilestoneResponsePut
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_milestone_by_system_id_and_poam_id_oapg(
        self,
    ...
    def _update_milestone_by_system_id_and_poam_id_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_milestones_request_put_body.serialize(body, content_type)
...
class UpdateMilestoneBySystemIdAndPoamId(BaseApi):
    ...
    def update_milestone_by_system_id_and_poam_id(
        ...
        return self._update_milestone_by_system_id_and_poam_id_oapg(
            body=body,
