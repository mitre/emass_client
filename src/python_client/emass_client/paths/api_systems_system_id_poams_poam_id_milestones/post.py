...
# body param
SchemaForRequestBodyApplicationJson = MilestonesRequestPostBody


request_body_milestones_request_post_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = MilestoneResponsePost
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_milestone_by_system_id_and_poam_id_oapg(
        self,
    ...
    def _add_milestone_by_system_id_and_poam_id_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_milestones_request_post_body.serialize(body, content_type)
...
class AddMilestoneBySystemIdAndPoamId(BaseApi):
    ...
    def add_milestone_by_system_id_and_poam_id(
        ...
        return self._add_milestone_by_system_id_and_poam_id_oapg(
            body=body,
