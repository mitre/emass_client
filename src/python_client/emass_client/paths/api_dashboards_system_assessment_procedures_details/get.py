...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_system_assessment_procedures_details_oapg(
        self,
...
class GetSystemAssessmentProceduresDetails(BaseApi):
    ...
    def get_system_assessment_procedures_details(
        ...
        return self._get_system_assessment_procedures_details_oapg(
