...
# body param
SchemaForRequestBodyApplicationJson = CacRequestPostBody


request_body_cac_request_post_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CacResponsePost
...
class BaseApi(api_client.Api):
    ...
    def _add_system_cac_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_cac_request_post_body.serialize(body, content_type)
...
class AddSystemCac(BaseApi):
    ...
    def add_system_cac(
        ...
        return self._add_system_cac_oapg(
            body=body,
