...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_va_system_threat_source_details_oapg(
        self,
...
class GetVaSystemThreatSourceDetails(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_va_system_threat_source_details(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_va_system_threat_source_details(
        ...
        return self._get_va_system_threat_source_details_oapg(
