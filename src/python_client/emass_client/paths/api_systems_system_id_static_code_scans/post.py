...
# body param
SchemaForRequestBodyApplicationJson = StaticCodeRequestPostBody


request_body_static_code_request_post_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = StaticCodeResponsePost
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_static_code_scans_by_system_id_oapg(
        self,
    ...
    def _add_static_code_scans_by_system_id_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_static_code_request_post_body.serialize(body, content_type)
...
class AddStaticCodeScansBySystemId(BaseApi):
    ...
    def add_static_code_scans_by_system_id(
        ...
        return self._add_static_code_scans_by_system_id_oapg(
            body=body,
