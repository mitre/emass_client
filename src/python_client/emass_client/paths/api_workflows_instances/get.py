...
# Query params
IncludeCommentsSchema = schemas.BoolSchema
PageIndexSchema = schemas.IntSchema
SinceDateSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'includeComments': typing.Union[IncludeCommentsSchema, bool, ],
        'pageIndex': typing.Union[PageIndexSchema, decimal.Decimal, int, ],
        'sinceDate': typing.Union[SinceDateSchema, str, ],
...
request_query_include_comments = api_client.QueryParameter(
    name="includeComments",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeCommentsSchema,
    explode=True,
)
request_query_page_index = api_client.QueryParameter(
    name="pageIndex",
    style=api_client.ParameterStyle.FORM,
    schema=PageIndexSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = WorkflowInstancesResponseGet
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_system_workflow_instances_oapg(
        self,
    ...
    def _get_system_workflow_instances_oapg(
        ...
        for parameter in (
            request_query_include_comments,
            request_query_page_index,
...
class GetSystemWorkflowInstances(BaseApi):
    ...
    def get_system_workflow_instances(
        ...
        return self._get_system_workflow_instances_oapg(
