...
SchemaFor200ResponseBodyApplicationJson = PoamResponseGetPoams
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_system_poams_by_poam_id_oapg(
        self,
...
class GetSystemPoamsByPoamId(BaseApi):
    ...
    def get_system_poams_by_poam_id(
        ...
        return self._get_system_poams_by_poam_id_oapg(
