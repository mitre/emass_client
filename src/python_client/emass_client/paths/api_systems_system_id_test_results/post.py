...
# body param
SchemaForRequestBodyApplicationJson = TestResultsRequestPostBody


request_body_test_results_request_post_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TestResultsResponsePost
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_test_results_by_system_id_oapg(
        self,
    ...
    def _add_test_results_by_system_id_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_test_results_request_post_body.serialize(body, content_type)
...
class AddTestResultsBySystemId(BaseApi):
    ...
    def add_test_results_by_system_id(
        ...
        return self._add_test_results_by_system_id_oapg(
            body=body,
