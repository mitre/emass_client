...
LatestOnlySchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'latestOnly': typing.Union[LatestOnlySchema, bool, ],
    },
    total=False
)
...
request_query_latest_only = api_client.QueryParameter(
    name="latestOnly",
    style=api_client.ParameterStyle.FORM,
    schema=LatestOnlySchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = TestResultsResponseGet
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_system_test_results_oapg(
        self,
...
class GetSystemTestResults(BaseApi):
    ...
    def get_system_test_results(
        ...
        return self._get_system_test_results_oapg(
