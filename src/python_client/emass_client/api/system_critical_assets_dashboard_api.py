...
class SystemCriticalAssetsDashboardApi:
    ...
    @validate_call
    def get_system_critical_assets_summary(
        self,
        ...
        _param = self._get_system_critical_assets_summary_serialize(
            org_id=org_id,
    ...
    @validate_call
    def get_system_critical_assets_summary_with_http_info(
        self,
        org_id: Annotated[StrictInt, Field(description="**Organization Id**: The unique organization identifier.")],
        excludeinherited: Annotated[Optional[StrictBool], Field(description="**Exclude Inherited**: If no value is specified, the default returns false to include inherited data. ")] = None,
        page_index: Annotated[Optional[StrictInt], Field(description="**Page Index**: If no value is specified, the default returns results from the first page with an index of 0. ")] = None,
    ...
    @validate_call
    def get_system_critical_assets_summary_without_preload_content(
        self,
        org_id: Annotated[StrictInt, Field(description="**Organization Id**: The unique organization identifier.")],
        excludeinherited: Annotated[Optional[StrictBool], Field(description="**Exclude Inherited**: If no value is specified, the default returns false to include inherited data. ")] = None,
        page_index: Annotated[Optional[StrictInt], Field(description="**Page Index**: If no value is specified, the default returns results from the first page with an index of 0. ")] = None,
    ...
    def _get_system_critical_assets_summary_serialize(
        self,
        org_id,
        excludeinherited,
        page_index,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/dashboards/system-critical-assets-summary',
