    ...
    def get_user_system_assignments_details(
        ...
        **kwargs,
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_user_system_assignments_details_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
