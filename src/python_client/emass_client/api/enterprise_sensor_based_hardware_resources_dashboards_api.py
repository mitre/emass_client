...
class EnterpriseSensorBasedHardwareResourcesDashboardsApi:
    ...
    def get_system_sensor_hardware_details(
        ...
        **kwargs,
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_system_sensor_hardware_details_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
    ...
    def get_system_sensor_hardware_summary(
        ...
        **kwargs,
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_system_sensor_hardware_summary_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
