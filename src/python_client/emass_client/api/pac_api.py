...
class PACApi(object):
    ...
    @validate_arguments
    def add_system_pac(self, system_id : Annotated[StrictInt, Field(..., description="**System Id**: The unique system record identifier.")], request_body : Annotated[conlist(Any), Field(..., description="Add system package to PAC for review")], **kwargs) -> PacResponsePost:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the add_system_pac_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.add_system_pac_with_http_info(system_id, request_body, **kwargs)  # noqa: E501

    @validate_arguments
    def add_system_pac_with_http_info(self, system_id : Annotated[StrictInt, Field(..., description="**System Id**: The unique system record identifier.")], request_body : Annotated[conlist(Any), Field(..., description="Add system package to PAC for review")], **kwargs) -> ApiResponse:  # noqa: E501
        """Submit system package for review  # noqa: E501
    ...
    def get_system_pac(self, system_id : Annotated[StrictInt, Field(..., description="**System Id**: The unique system record identifier.")], **kwargs) -> PacResponseGet:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_system_pac_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
