...
class PACApi:
    ...
    def add_system_pac(
        ...
        request_body: Annotated[List[Optional[object]], Field(description="Example request body for adding system package to PAC for review")],
        ...
        :type system_id: int
        :param request_body: Example request body for adding system package to PAC for review (required)
        ...
        _param = self._add_system_pac_serialize(
            system_id=system_id,
    ...
    @validate_call
    def add_system_pac_without_preload_content(
        self,
        system_id: Annotated[StrictInt, Field(description="**System Id**: The unique system record identifier.")],
        request_body: Annotated[List[Optional[object]], Field(description="Example request body for adding system package to PAC for review")],
        _request_timeout: Union[
    ...
    def _add_system_pac_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/systems/{systemId}/approval/pac',
    ...
    def get_system_pac(
        ...
        _param = self._get_system_pac_serialize(
            system_id=system_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_system_pac_without_preload_content(
        self,
        system_id: Annotated[StrictInt, Field(description="**System Id**: The unique system record identifier.")],
        _request_timeout: Union[
            None,
