...
class WorkflowDefinitionsApi:
    ...
    def get_workflow_definitions(
        ...
        _param = self._get_workflow_definitions_serialize(
    ...
    def get_workflow_definitions_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WorkflowDefinitionResponseGet]:
        """Get workflow definitions in a site
    ...
    @validate_call
    def get_workflow_definitions_without_preload_content(
        self,
        include_inactive: Annotated[Optional[StrictBool], Field(description="**Include Inactive**: If no value is specified, the default returns false to not include outdated workflow definitions.")] = None,
        registration_type: Annotated[Optional[StrictStr], Field(description="**Registration Type**: Filter record by selected registration type (single value or comma delimited values).  **Valid Options Are:** assessAndAuthorize, assessOnly, guest, regular, functional, cloudServiceProvider, commonControlProvider, authorizationToUse, reciprocityAcceptanc ")] = None,
        _request_timeout: Union[
    ...
    def _get_workflow_definitions_serialize(
        self,
        include_inactive,
        registration_type,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/workflows/definitions',
