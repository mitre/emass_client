...
class EnterpriseTermsConditionsDashboardsApi:
    ...
    def get_system_terms_conditions_details(self, org_id : Annotated[StrictInt, Field(description="**Organization Id**: The unique organization identifier.")], excludeinherited : Annotated[Optional[StrictBool], Field(description="**Exclude Inherited**: If no value is specified, the default returns false to include inherited data. ")] = None, page_index : Annotated[Optional[StrictInt], Field(description="**Page Index**: If no value is specified, the default returns results from the first page with an index of 0. ")] = None, page_size : Annotated[Optional[StrictInt], Field(description="**Page Size**: If no value is specified, the default returns 20000 per page. ")] = None, **kwargs) -> object:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_system_terms_conditions_details_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_system_terms_conditions_details_with_http_info(org_id, excludeinherited, page_index, page_size, **kwargs)  # noqa: E501

    @validate_call
    def get_system_terms_conditions_details_with_http_info(self, org_id : Annotated[StrictInt, Field(description="**Organization Id**: The unique organization identifier.")], excludeinherited : Annotated[Optional[StrictBool], Field(description="**Exclude Inherited**: If no value is specified, the default returns false to include inherited data. ")] = None, page_index : Annotated[Optional[StrictInt], Field(description="**Page Index**: If no value is specified, the default returns results from the first page with an index of 0. ")] = None, page_size : Annotated[Optional[StrictInt], Field(description="**Page Size**: If no value is specified, the default returns 20000 per page. ")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """System Terms Conditions Details  # noqa: E501
        ...
        >>> thread = api.get_system_terms_conditions_details_with_http_info(org_id, excludeinherited, page_index, page_size, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_system_terms_conditions_details" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/dashboards/system-terms-conditions-details', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def get_system_terms_conditions_summary(self, org_id : Annotated[StrictInt, Field(description="**Organization Id**: The unique organization identifier.")], excludeinherited : Annotated[Optional[StrictBool], Field(description="**Exclude Inherited**: If no value is specified, the default returns false to include inherited data. ")] = None, page_index : Annotated[Optional[StrictInt], Field(description="**Page Index**: If no value is specified, the default returns results from the first page with an index of 0. ")] = None, page_size : Annotated[Optional[StrictInt], Field(description="**Page Size**: If no value is specified, the default returns 20000 per page. ")] = None, **kwargs) -> object:  # noqa: E501
        ...
        Get systems terms conditions summary dashboard information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_system_terms_conditions_summary(org_id, excludeinherited, page_index, page_size, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_system_terms_conditions_summary_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_system_terms_conditions_summary_with_http_info(org_id, excludeinherited, page_index, page_size, **kwargs)  # noqa: E501

    @validate_call
    def get_system_terms_conditions_summary_with_http_info(self, org_id : Annotated[StrictInt, Field(description="**Organization Id**: The unique organization identifier.")], excludeinherited : Annotated[Optional[StrictBool], Field(description="**Exclude Inherited**: If no value is specified, the default returns false to include inherited data. ")] = None, page_index : Annotated[Optional[StrictInt], Field(description="**Page Index**: If no value is specified, the default returns results from the first page with an index of 0. ")] = None, page_size : Annotated[Optional[StrictInt], Field(description="**Page Size**: If no value is specified, the default returns 20000 per page. ")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """System Terms Conditions Summary  # noqa: E501
        ...
        >>> thread = api.get_system_terms_conditions_summary_with_http_info(org_id, excludeinherited, page_index, page_size, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_system_terms_conditions_summary" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/dashboards/system-terms-conditions-summary', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
