...
class ContainerScanResultsApi(object):
    ...
    @validate_arguments
    def add_container_sans_by_system_id(self, system_id : Annotated[StrictInt, Field(..., description="**System Id**: The unique system record identifier.")], request_body : Annotated[conlist(Any), Field(..., description="Add containers and their scan results")], **kwargs) -> ContainersResponsePost:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the add_container_sans_by_system_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.add_container_sans_by_system_id_with_http_info(system_id, request_body, **kwargs)  # noqa: E501

    @validate_arguments
    def add_container_sans_by_system_id_with_http_info(self, system_id : Annotated[StrictInt, Field(..., description="**System Id**: The unique system record identifier.")], request_body : Annotated[conlist(Any), Field(..., description="Add containers and their scan results")], **kwargs) -> ApiResponse:  # noqa: E501
        """Add one or many containers and their scan results  # noqa: E501
