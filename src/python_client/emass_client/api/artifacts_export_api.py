...
class ArtifactsExportApi:
    ...
    def get_system_artifacts_export(
        ...
        **kwargs,
        ...
        >>> thread = api.get_system_artifacts_export(system_id, filename, compress, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_system_artifacts_export_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
    ...
    def get_system_artifacts_export_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.get_system_artifacts_export_with_http_info(system_id, filename, compress, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_system_artifacts_export" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/systems/{systemId}/artifacts-export', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
