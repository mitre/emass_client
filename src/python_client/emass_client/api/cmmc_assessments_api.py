...
class CMMCAssessmentsApi:
    ...
    def get_cmmc_assessments(
        ...
        _param = self._get_cmmc_assessments_serialize(
    ...
    @validate_call
    def get_cmmc_assessments_without_preload_content(
        self,
        since_date: Annotated[StrictStr, Field(description="**Date** CMMC date (Unix date format)")],
        _request_timeout: Union[
            None,
    ...
    def _get_cmmc_assessments_serialize(
        self,
        since_date,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/cmmc-assessments',
