...
class CloudResourceResultsApi:
    ...
    def add_cloud_resources_by_system_id(
        ...
        request_body: Annotated[List[Optional[object]], Field(description="Example request body for adding cloud resources and their scan results")],
        ...
        :type system_id: int
        :param request_body: Example request body for adding cloud resources and their scan results (required)
        ...
        _param = self._add_cloud_resources_by_system_id_serialize(
            system_id=system_id,
    ...
    def add_cloud_resources_by_system_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CloudResourcesResponsePost]:
        """Add one or many cloud resources and their scan results
    ...
    @validate_call
    def add_cloud_resources_by_system_id_without_preload_content(
        self,
        system_id: Annotated[StrictInt, Field(description="**System Id**: The unique system record identifier.")],
        request_body: Annotated[List[Optional[object]], Field(description="Example request body for adding cloud resources and their scan results")],
        _request_timeout: Union[
    ...
    def _add_cloud_resources_by_system_id_serialize(
        self,
        system_id,
        request_body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/systems/{systemId}/cloud-resource-results',
    ...
    def delete_cloud_resources(
        ...
        _param = self._delete_cloud_resources_serialize(
            system_id=system_id,
            cloud_resources_delete_body_inner=cloud_resources_delete_body_inner,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def delete_cloud_resources_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CloudResourcesDelete]:
        """Remove one or many cloud resources in a system
    ...
    @validate_call
    def delete_cloud_resources_without_preload_content(
        self,
        system_id: Annotated[StrictInt, Field(description="**System Id**: The unique system record identifier.")],
        cloud_resources_delete_body_inner: Annotated[List[CloudResourcesDeleteBodyInner], Field(description="Delete the given Cloud Resource Id")],
        _request_timeout: Union[
    ...
    def _delete_cloud_resources_serialize(
        self,
        system_id,
        ...
        # process the form parameters
        # process the body parameter
        if cloud_resources_delete_body_inner is not None:
            _body_params = cloud_resources_delete_body_inner
