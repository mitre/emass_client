...
class CloudResourceResultsApi:
    ...
    def add_cloud_resources_by_system_id(
        ...
        **kwargs,
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the add_cloud_resources_by_system_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
    ...
    def delete_cloud_resources(
        ...
        **kwargs,
        ...
        >>> thread = api.delete_cloud_resources(system_id, cloud_resources_delete_body_inner, async_req=True)
        >>> result = thread.get()

        :param system_id: **System Id**: The unique system record identifier. (required)
        :type system_id: int
        :param cloud_resources_delete_body_inner: Delete the given Cloud Resource Id (required)
        :type cloud_resources_delete_body_inner: List[CloudResourcesDeleteBodyInner]
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: CloudResourcesDelete
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_cloud_resources_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
    ...
    def delete_cloud_resources_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.delete_cloud_resources_with_http_info(system_id, cloud_resources_delete_body_inner, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CloudResourcesDelete, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_cloud_resources" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['cloud_resources_delete_body_inner'] is not None:
            _body_params = _params['cloud_resources_delete_body_inner']
        ...
        return self.api_client.call_api(
            '/api/systems/{systemId}/cloud-resource-results', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
