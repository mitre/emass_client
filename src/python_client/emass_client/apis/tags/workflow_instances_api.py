...
from emass_client.paths.api_workflows_instances.get import GetSystemWorkflowInstances
from emass_client.paths.api_workflows_instances_workflow_instance_id.get import GetSystemWorkflowInstancesByWorkflowInstanceId


class WorkflowInstancesApi(
    GetSystemWorkflowInstances,
    GetSystemWorkflowInstancesByWorkflowInstanceId,
):
