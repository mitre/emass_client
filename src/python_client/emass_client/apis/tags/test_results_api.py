...
from emass_client.paths.api_systems_system_id_test_results.post import AddTestResultsBySystemId
from emass_client.paths.api_systems_system_id_test_results.get import GetSystemTestResults


class TestResultsApi(
    AddTestResultsBySystemId,
