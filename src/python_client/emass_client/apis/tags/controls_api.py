...
from emass_client.paths.api_systems_system_id_controls.get import GetSystemControls
from emass_client.paths.api_systems_system_id_controls.put import UpdateControlBySystemId


class ControlsApi(
    GetSystemControls,
    UpdateControlBySystemId,
):
