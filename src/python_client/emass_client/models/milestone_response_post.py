...
class MilestoneResponsePost(BaseModel):
    """
    MilestoneResponsePost
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(MilestonesPutPostDelete)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MilestoneResponsePost:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MilestoneResponsePost:
        """Create an instance of MilestoneResponsePost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MilestoneResponsePost.parse_obj(obj)

        _obj = MilestoneResponsePost.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [MilestonesPutPostDelete.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
