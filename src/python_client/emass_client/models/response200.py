...
class Response200(BaseModel):
    ...
    Response200
    """
    code: Optional[conint(strict=True, le=200, ge=200)] = 200
    __properties = ["code"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Response200:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Response200:
        """Create an instance of Response200 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Response200.parse_obj(obj)

        _obj = Response200.parse_obj({
