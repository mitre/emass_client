...
class HwBaselineOptionalFields(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["componentType", "nickname", "assetIpAddress", "publicFacing", "virtualAsset", "manufacturer", "modelNumber", "serialNumber", "OsIosFwVersion", "memorySizeType", "location", "approvalStatus", "criticalAsset"]
