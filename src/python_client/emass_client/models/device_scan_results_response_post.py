...
class DeviceScanResultsResponsePost(BaseModel):
    """
    DeviceScanResultsResponsePost
    """ # noqa: E501
    meta: Optional[Response200] = None
    data: Optional[List[DeviceScanResultsResponsePostDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [DeviceScanResultsResponsePostDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
