...
class PoamResponsePost(BaseModel):
    """
    PoamResponsePost
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PoamResponsePost:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PoamResponsePost:
        """Create an instance of PoamResponsePost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PoamResponsePost.parse_obj(obj)

        _obj = PoamResponsePost.parse_obj({
