...
class ArtifactsResponseGetDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["systemId", "filename", "isTemplate", "type", "category", "isInherited", "ccis", "mimeContentType", "fileSize", "name", "description", "referencePageNumber", "assessmentProcedures", "controls", "expirationDate", "lastReviewedDate", "signedDate"]
