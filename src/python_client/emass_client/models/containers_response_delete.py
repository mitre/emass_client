...
class ContainersResponseDelete(BaseModel):
    """
    ContainersResponseDelete
    """
    meta: Optional[Response200] = None
    data: Optional[List[ContainersResourcesPostDelete]] = None
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ContainersResourcesPostDelete.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
