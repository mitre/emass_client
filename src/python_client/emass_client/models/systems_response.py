...
class SystemsResponse(BaseModel):
    ...
    data: Optional[conlist(Systems)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SystemsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SystemsResponse:
        """Create an instance of SystemsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SystemsResponse.parse_obj(obj)

        _obj = SystemsResponse.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [Systems.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
