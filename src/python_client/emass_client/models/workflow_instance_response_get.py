...
class WorkflowInstanceResponseGet(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkflowInstanceResponseGet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkflowInstanceResponseGet:
        """Create an instance of WorkflowInstanceResponseGet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkflowInstanceResponseGet.parse_obj(obj)
