...
class DashboardMockResponsePagination(BaseModel):
    ...
    __properties = ["totalCount", "totalPages", "pageIndex", "pageSize", "prevPageUrl", "nextPageUrl"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DashboardMockResponsePagination:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DashboardMockResponsePagination:
        """Create an instance of DashboardMockResponsePagination from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DashboardMockResponsePagination.parse_obj(obj)

        _obj = DashboardMockResponsePagination.parse_obj({
