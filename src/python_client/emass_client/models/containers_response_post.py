...
class ContainersResponsePost(BaseModel):
    """
    ContainersResponsePost
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(ContainersResourcesPost)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContainersResponsePost:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContainersResponsePost:
        """Create an instance of ContainersResponsePost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContainersResponsePost.parse_obj(obj)

        _obj = ContainersResponsePost.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [ContainersResourcesPost.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
