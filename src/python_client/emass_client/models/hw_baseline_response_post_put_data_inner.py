...
class HwBaselineResponsePostPutDataInner(BaseModel):
    """
    HwBaselineResponsePostPutDataInner
    """ # noqa: E501
    system_id: Optional[StrictInt] = Field(default=None, alias="systemId")
    hardware_id: Optional[StrictStr] = Field(default=None, alias="hardwareId")
    success: Optional[StrictBool] = None
    errors: Optional[Annotated[List[Any], Field(min_length=1, max_length=25)]] = None
    __properties: ClassVar[List[str]] = ["systemId", "hardwareId", "success", "errors"]
