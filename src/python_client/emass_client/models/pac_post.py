...
class PacPost(BaseModel):
    ...
    __properties = ["workflow", "success", "systemId", "errors"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PacPost:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PacPost:
        """Create an instance of PacPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PacPost.parse_obj(obj)

        _obj = PacPost.parse_obj({
