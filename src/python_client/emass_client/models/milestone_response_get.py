...
class MilestoneResponseGet(BaseModel):
    """
    MilestoneResponseGet
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(MilestonesGet)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MilestoneResponseGet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MilestoneResponseGet:
        """Create an instance of MilestoneResponseGet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MilestoneResponseGet.parse_obj(obj)

        _obj = MilestoneResponseGet.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [MilestonesGet.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
