...
class SwBaselineResponsePostPut(BaseModel):
    """
    SwBaselineResponsePostPut
    """ # noqa: E501
    meta: Optional[Response200] = None
    data: Optional[List[SwBaselineResponsePostPutDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [SwBaselineResponsePostPutDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
