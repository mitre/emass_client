...
class MilestonesPutPostDelete(BaseModel):
    ...
    """
    system_id: Optional[StrictInt] = Field(None, alias="systemId", description="The system identifier that the POAM was added.")
    poam_id: Optional[StrictInt] = Field(None, alias="poamId", description="The newly created POAM identifier")
    milestone_id: Optional[StrictInt] = Field(None, alias="milestoneId", description="The Milestone unique item identifier")
    ...
    __properties = ["systemId", "poamId", "milestoneId", "externalUid", "success", "errors"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MilestonesPutPostDelete:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MilestonesPutPostDelete:
        """Create an instance of MilestonesPutPostDelete from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MilestonesPutPostDelete.parse_obj(obj)

        _obj = MilestonesPutPostDelete.parse_obj({
