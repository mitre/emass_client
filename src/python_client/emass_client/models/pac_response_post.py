...
class PacResponsePost(BaseModel):
    """
    PacResponsePost
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(PacPost)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PacResponsePost:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PacResponsePost:
        """Create an instance of PacResponsePost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PacResponsePost.parse_obj(obj)

        _obj = PacResponsePost.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [PacPost.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
