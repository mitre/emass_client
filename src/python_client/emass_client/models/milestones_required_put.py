...
class MilestonesRequiredPut(BaseModel):
    ...
    """
    milestone_id: StrictInt = Field(description="[Required] Unique item identifier", alias="milestoneId")
    description: StrictStr = Field(description="[Required] Include milestone description.")
    scheduled_completion_date: StrictInt = Field(description="[Required] Shecdule completion date. Unix time format.", alias="scheduledCompletionDate")
    __properties: ClassVar[List[str]] = ["milestoneId", "description", "scheduledCompletionDate"]
