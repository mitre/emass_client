...
class HwBaselineResponseGet(BaseModel):
    """
    HwBaselineResponseGet
    """ # noqa: E501
    meta: Optional[Response200] = None
    data: Optional[List[HwBaselineResponseGetDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [HwBaselineResponseGetDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
