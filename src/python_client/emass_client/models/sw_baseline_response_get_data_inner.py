...
class SwBaselineResponseGetDataInner(BaseModel):
    """
    ...
    software_vendor: Optional[StrictStr] = Field(default=None, description="[Required] Vendor of the software asset.", alias="softwareVendor")
    software_name: Optional[StrictStr] = Field(default=None, description="[Required] Name of the software asset.", alias="softwareName")
    version: Optional[StrictStr] = Field(default=None, description="[Required] Version of the software asset.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "softwareVendor": obj.get("softwareVendor"),
