...
class TestResultsResponsePost(BaseModel):
    """
    TestResultsResponsePost
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(TestResultsPost)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultsResponsePost:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestResultsResponsePost:
        """Create an instance of TestResultsResponsePost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultsResponsePost.parse_obj(obj)

        _obj = TestResultsResponsePost.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [TestResultsPost.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
