...
class MilestoneResponsePut(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MilestoneResponsePut:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MilestoneResponsePut:
        """Create an instance of MilestoneResponsePut from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MilestoneResponsePut.parse_obj(obj)

        _obj = MilestoneResponsePut.parse_obj({
