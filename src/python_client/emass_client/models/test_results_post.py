...
class TestResultsPost(BaseModel):
    ...
    TestResultsPost
    """
    cci: Optional[StrictStr] = Field(None, description="CCI associated with test result.")
    ...
    __properties = ["cci", "success", "systemId", "errors"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultsPost:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestResultsPost:
        """Create an instance of TestResultsPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultsPost.parse_obj(obj)

        _obj = TestResultsPost.parse_obj({
            "cci": obj.get("cci"),
