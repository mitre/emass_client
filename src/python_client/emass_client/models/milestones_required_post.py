...
class MilestonesRequiredPost(BaseModel):
    ...
    """ # noqa: E501
    milestones: Optional[List[MilestonesRequiredPostMilestonesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "milestones": [MilestonesRequiredPostMilestonesInner.from_dict(_item) for _item in obj["milestones"]] if obj.get("milestones") is not None else None
        })
        return _obj
