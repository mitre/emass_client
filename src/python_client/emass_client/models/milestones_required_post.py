...
class MilestonesRequiredPost(BaseModel):
    ...
    scheduled_completion_date: StrictInt = Field(description="[Required] Required for ongoing and completed POA&M items. Unix time format.", alias="scheduledCompletionDate")
    __properties: ClassVar[List[str]] = ["description", "scheduledCompletionDate"]
