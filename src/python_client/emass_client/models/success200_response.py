...
class Success200Response(BaseModel):
    ...
    data: Optional[conlist(Success200ResponseDataInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Success200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Success200Response:
        """Create an instance of Success200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Success200Response.parse_obj(obj)

        _obj = Success200Response.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [Success200ResponseDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
