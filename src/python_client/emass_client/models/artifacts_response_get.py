...
class ArtifactsResponseGet(BaseModel):
    """
    ArtifactsResponseGet
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(ArtifactsGet)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArtifactsResponseGet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArtifactsResponseGet:
        """Create an instance of ArtifactsResponseGet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArtifactsResponseGet.parse_obj(obj)

        _obj = ArtifactsResponseGet.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [ArtifactsGet.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
