...
class CloudResourcesPostDelete(BaseModel):
    """
    CloudResourcesPostDelete
    """
    resource_id: Optional[StrictStr] = Field(default=None, description="[Required] Unique identifier/resource namespace for policy compliance result", alias="resourceId")
    ...
    __properties: ClassVar[List[str]] = ["resourceId", "success", "systemId", "errors"]
