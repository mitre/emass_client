...
class SystemResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SystemResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SystemResponse:
        """Create an instance of SystemResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SystemResponse.parse_obj(obj)

        _obj = SystemResponse.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": Systems.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
