...
class SwBaselineConditionalFields(BaseModel):
    """
    SwBaselineConditionalFields
    """ # noqa: E501
    approval_date: Optional[StrictInt] = Field(default=None, description="[Conditional] Approval date of the software asset. If Approval Status is set to \"Unapproved\" or \"In Progress\", Approval Date will be set to null.", alias="approvalDate")
    __properties: ClassVar[List[str]] = ["approvalDate"]
