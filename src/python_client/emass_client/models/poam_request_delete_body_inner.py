...
class PoamRequestDeleteBodyInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PoamRequestDeleteBodyInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PoamRequestDeleteBodyInner:
        """Create an instance of PoamRequestDeleteBodyInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PoamRequestDeleteBodyInner.parse_obj(obj)

        _obj = PoamRequestDeleteBodyInner.parse_obj({
