...
class MilestonesRequiredPutMilestonesInner(BaseModel):
    """
    ...
    is_active: StrictBool = Field(description="[Conditional] Optionally used in PUT to delete milestones when updating a POA&M.", alias="isActive")
    __properties: ClassVar[List[str]] = ["description", "scheduledCompletionDate", "isActive"]
