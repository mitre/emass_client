...
class PoamResponseGetSystemsDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["systemId", "poamId", "displayPoamId", "status", "vulnerabilityDescription", "sourceIdentifyingVulnerability", "pocOrganization", "resources", "identifiedInCFOAuditOrOtherReview", "pocFirstName", "pocLastName", "pocEmail", "pocPhoneNumber", "severity", "scheduledCompletionDate", "completionDate", "comments", "personnelResourcesFundedBaseHours", "personnelResourcesCostCode", "personnelResourcesUnfundedBaseHours", "personnelResourcesNonfundingObstacle", "personnelResourcesNonfundingObstacleOtherReason", "nonPersonnelResourcesFundedAmount", "nonPersonnelResourcesCostCode", "nonPersonnelResourcesUnfundedAmount", "nonPersonnelResourcesNonfundingObstacle", "nonPersonnelResourcesNonfundingObstacleOtherReason", "milestones", "externalUid", "controlAcronym", "assessmentProcedure", "securityChecks", "rawSeverity", "relevanceOfThreat", "likelihood", "impact", "impactDescription", "residualRiskLevel", "recommendations", "mitigations", "resultingResidualRiskLevelAfterProposedMitigations", "predisposingConditions", "threatDescription", "devicesAffected", "conditionId", "isInherited", "cci", "reviewStatus", "createdDate", "extensionDate", "pendingExtensionDate", "artifacts"]
