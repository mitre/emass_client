...
class SwBaselineResponsePostPutDataInner(BaseModel):
    """
    SwBaselineResponsePostPutDataInner
    """ # noqa: E501
    system_id: Optional[StrictInt] = Field(default=None, alias="systemId")
    software_id: Optional[StrictStr] = Field(default=None, alias="softwareId")
    success: Optional[StrictBool] = None
    errors: Optional[Annotated[List[Any], Field(min_length=1, max_length=25)]] = None
    __properties: ClassVar[List[str]] = ["systemId", "softwareId", "success", "errors"]
