...
class ControlsResponsePut(BaseModel):
    """
    ControlsResponsePut
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(ControlsPut)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ControlsResponsePut:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ControlsResponsePut:
        """Create an instance of ControlsResponsePut from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ControlsResponsePut.parse_obj(obj)

        _obj = ControlsResponsePut.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [ControlsPut.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
