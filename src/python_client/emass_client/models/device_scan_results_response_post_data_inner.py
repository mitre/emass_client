...
class DeviceScanResultsResponsePostDataInner(BaseModel):
    """
    DeviceScanResultsResponsePostDataInner
    """ # noqa: E501
    filename: Optional[StrictStr] = Field(default=None, description="[Required] single binary file. Specific file extensions are expected depending upon the scanType parameter.")
    assets_imported: Optional[StrictInt] = Field(default=None, description="Number of assets imported from the scan file.", alias="assetsImported")
    ...
    __properties: ClassVar[List[str]] = ["filename", "assetsImported", "success", "systemId", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assetsImported": obj.get("assetsImported"),
