...
class Success200ResponseDataInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Success200ResponseDataInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Success200ResponseDataInner:
        """Create an instance of Success200ResponseDataInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Success200ResponseDataInner.parse_obj(obj)

        _obj = Success200ResponseDataInner.parse_obj({
