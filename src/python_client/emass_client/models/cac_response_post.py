...
class CacResponsePost(BaseModel):
    """
    CacResponsePost
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(CacResponsePostDataInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CacResponsePost:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CacResponsePost:
        """Create an instance of CacResponsePost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CacResponsePost.parse_obj(obj)

        _obj = CacResponsePost.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [CacResponsePostDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
