...
class Response500Meta(BaseModel):
    ...
    Response500Meta
    """
    code: Optional[Annotated[int, Field(le=500, strict=True, ge=500)]] = 500
    error_message: Optional[StrictStr] = Field(default='Server encountered an unexpected condition which prevented it from fulfilling the request', alias="errorMessage")
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "errorMessage": obj.get("errorMessage") if obj.get("errorMessage") is not None else 'Server encountered an unexpected condition which prevented it from fulfilling the request'
        })
        return _obj
