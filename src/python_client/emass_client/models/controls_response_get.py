...
class ControlsResponseGet(BaseModel):
    """
    ControlsResponseGet
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(ControlsGet)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ControlsResponseGet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ControlsResponseGet:
        """Create an instance of ControlsResponseGet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ControlsResponseGet.parse_obj(obj)

        _obj = ControlsResponseGet.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [ControlsGet.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
