...
class ContainersResourcesPostDelete(BaseModel):
    """
    ContainersResourcesPostDelete
    """
    container_id: Optional[StrictStr] = Field(default=None, description="[Required] Unique identifier of the container", alias="containerId")
    ...
    __properties: ClassVar[List[str]] = ["containerId", "success", "systemId", "errors"]
