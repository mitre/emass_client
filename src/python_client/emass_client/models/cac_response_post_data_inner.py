...
class CacResponsePostDataInner(BaseModel):
    """
    ...
    __properties = ["controlAcronym", "success", "systemId", "errors"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CacResponsePostDataInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CacResponsePostDataInner:
        """Create an instance of CacResponsePostDataInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CacResponsePostDataInner.parse_obj(obj)

        _obj = CacResponsePostDataInner.parse_obj({
