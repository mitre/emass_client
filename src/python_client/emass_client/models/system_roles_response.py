...
class SystemRolesResponse(BaseModel):
    ...
    data: Optional[conlist(SystemRolesResponseDataInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SystemRolesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SystemRolesResponse:
        """Create an instance of SystemRolesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SystemRolesResponse.parse_obj(obj)

        _obj = SystemRolesResponse.parse_obj({
