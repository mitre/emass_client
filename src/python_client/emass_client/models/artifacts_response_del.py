...
class ArtifactsResponseDel(BaseModel):
    """
    ArtifactsResponseDel
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(ArtifactsResponseDelDataInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArtifactsResponseDel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArtifactsResponseDel:
        """Create an instance of ArtifactsResponseDel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArtifactsResponseDel.parse_obj(obj)

        _obj = ArtifactsResponseDel.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [ArtifactsResponseDelDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
