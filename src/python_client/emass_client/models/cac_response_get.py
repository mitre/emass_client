...
class CacResponseGet(BaseModel):
    """
    CacResponseGet
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(CacGet)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CacResponseGet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CacResponseGet:
        """Create an instance of CacResponseGet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CacResponseGet.parse_obj(obj)

        _obj = CacResponseGet.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [CacGet.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
