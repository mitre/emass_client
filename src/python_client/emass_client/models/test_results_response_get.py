...
class TestResultsResponseGet(BaseModel):
    """
    TestResultsResponseGet
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(TestResultsGet)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultsResponseGet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestResultsResponseGet:
        """Create an instance of TestResultsResponseGet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultsResponseGet.parse_obj(obj)

        _obj = TestResultsResponseGet.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [TestResultsGet.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
