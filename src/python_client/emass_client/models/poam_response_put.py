...
class PoamResponsePut(BaseModel):
    """
    PoamResponsePut
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PoamResponsePut:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PoamResponsePut:
        """Create an instance of PoamResponsePut from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PoamResponsePut.parse_obj(obj)

        _obj = PoamResponsePut.parse_obj({
