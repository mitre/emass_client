...
class WorkflowDefinitionResponseGet(BaseModel):
    """
    WorkflowDefinitionResponseGet
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(WorkflowDefinitionGet)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkflowDefinitionResponseGet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkflowDefinitionResponseGet:
        """Create an instance of WorkflowDefinitionResponseGet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkflowDefinitionResponseGet.parse_obj(obj)

        _obj = WorkflowDefinitionResponseGet.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [WorkflowDefinitionGet.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
