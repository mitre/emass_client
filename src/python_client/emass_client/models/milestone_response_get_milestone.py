...
class MilestoneResponseGetMilestone(BaseModel):
    """
    MilestoneResponseGetMilestone
    """
    meta: Optional[Response200] = None
    data: Optional[MilestonesGet] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MilestoneResponseGetMilestone:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MilestoneResponseGetMilestone:
        """Create an instance of MilestoneResponseGetMilestone from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MilestoneResponseGetMilestone.parse_obj(obj)

        _obj = MilestoneResponseGetMilestone.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": MilestonesGet.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
