...
class PoamResponseGetSystems(BaseModel):
    """
    PoamResponseGetSystems
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(PoamGet)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PoamResponseGetSystems:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PoamResponseGetSystems:
        """Create an instance of PoamResponseGetSystems from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PoamResponseGetSystems.parse_obj(obj)

        _obj = PoamResponseGetSystems.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [PoamGet.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
