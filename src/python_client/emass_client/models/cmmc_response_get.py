...
class CmmcResponseGet(BaseModel):
    """
    CmmcResponseGet
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(CmmcGet)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CmmcResponseGet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CmmcResponseGet:
        """Create an instance of CmmcResponseGet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CmmcResponseGet.parse_obj(obj)

        _obj = CmmcResponseGet.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [CmmcGet.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
