...
class WorkflowInstancesResponseGet(BaseModel):
    ...
    data: Optional[List[WorkflowInstanceGet]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [WorkflowInstanceGet.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "pagination": WorkflowInstancesResponseGetPagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
