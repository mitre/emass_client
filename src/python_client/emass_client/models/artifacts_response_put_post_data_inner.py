...
class ArtifactsResponsePutPostDataInner(BaseModel):
    """
    ...
    __properties = ["filename", "success", "systemId", "errors"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArtifactsResponsePutPostDataInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArtifactsResponsePutPostDataInner:
        """Create an instance of ArtifactsResponsePutPostDataInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArtifactsResponsePutPostDataInner.parse_obj(obj)

        _obj = ArtifactsResponsePutPostDataInner.parse_obj({
