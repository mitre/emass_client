...
class ArtifactsResponsePutPostDataInner(BaseModel):
    ...
    """
    filename: Optional[StrictStr] = Field(default=None, description="[Required] File name should match exactly one file within the provided zip file. 1000 Characters.")
    ...
    __properties: ClassVar[List[str]] = ["filename", "success", "systemId", "errors"]
