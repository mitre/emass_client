...
class ArtifactsResponsePutPost(BaseModel):
    """
    ArtifactsResponsePutPost
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(ArtifactsResponsePutPostDataInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArtifactsResponsePutPost:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArtifactsResponsePutPost:
        """Create an instance of ArtifactsResponsePutPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArtifactsResponsePutPost.parse_obj(obj)

        _obj = ArtifactsResponsePutPost.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [ArtifactsResponsePutPostDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
