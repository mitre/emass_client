...
class CloudResourcesResponsePost(BaseModel):
    """
    CloudResourcesResponsePost
    """
    meta: Optional[Response200] = None
    data: Optional[conlist(CloudResourcesPost)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CloudResourcesResponsePost:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CloudResourcesResponsePost:
        """Create an instance of CloudResourcesResponsePost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CloudResourcesResponsePost.parse_obj(obj)

        _obj = CloudResourcesResponsePost.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [CloudResourcesPost.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
