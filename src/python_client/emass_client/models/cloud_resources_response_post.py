...
class CloudResourcesResponsePost(BaseModel):
    ...
    data: Optional[List[CloudResourcesPostDelete]] = None
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": [CloudResourcesPostDelete.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
