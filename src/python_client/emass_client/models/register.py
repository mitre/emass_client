...
class Register(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Register:
    ...
    def from_dict(cls, obj: dict) -> Register:
        ...
        if not isinstance(obj, dict):
            return Register.parse_obj(obj)

        _obj = Register.parse_obj({
            "meta": Response200.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": RegisterData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
