...
class MilestonesRequestDeleteBodyInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MilestonesRequestDeleteBodyInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MilestonesRequestDeleteBodyInner:
        """Create an instance of MilestonesRequestDeleteBodyInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MilestonesRequestDeleteBodyInner.parse_obj(obj)

        _obj = MilestonesRequestDeleteBodyInner.parse_obj({
