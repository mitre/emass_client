...
class DefinitionTransitions(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="[Read-Only] Description that matches the action dropdown that appears for PAC users.")
    roles: Optional[List[Any]] = None
    __properties: ClassVar[List[str]] = ["endStage", "description", "roles"]
