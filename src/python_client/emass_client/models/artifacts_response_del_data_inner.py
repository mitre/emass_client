...
class ArtifactsResponseDelDataInner(BaseModel):
    """
    ...
    __properties = ["filename", "success", "systemId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArtifactsResponseDelDataInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArtifactsResponseDelDataInner:
        """Create an instance of ArtifactsResponseDelDataInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArtifactsResponseDelDataInner.parse_obj(obj)

        _obj = ArtifactsResponseDelDataInner.parse_obj({
