...
class ContainerResourcesDeleteBodyInner(BaseModel):
    """
    ContainerResourcesDeleteBodyInner
    """
    container_id: Optional[StrictStr] = Field(default=None, description="[Required] Unique item identifier", alias="containerId")
