...
class CloudResourcesDeleteBodyInner(BaseModel):
    """
    CloudResourcesDeleteBodyInner
    """
    resource_id: Optional[StrictStr] = Field(default=None, description="[Required] Unique item identifier", alias="resourceId")
