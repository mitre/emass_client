...
class WorkflowInstanceGet(BaseModel):
    ...
    __properties = ["workflowUid", "systemName", "workflowInstanceId", "packageName", "createdDate", "lastEditedDate", "lastEditedBy", "workflow", "version", "currentStage", "transitions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkflowInstanceGet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkflowInstanceGet:
        """Create an instance of WorkflowInstanceGet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkflowInstanceGet.parse_obj(obj)

        _obj = WorkflowInstanceGet.parse_obj({
