...
class ArtifactsRequestDeleteBodyInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArtifactsRequestDeleteBodyInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArtifactsRequestDeleteBodyInner:
        """Create an instance of ArtifactsRequestDeleteBodyInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArtifactsRequestDeleteBodyInner.parse_obj(obj)

        _obj = ArtifactsRequestDeleteBodyInner.parse_obj({
