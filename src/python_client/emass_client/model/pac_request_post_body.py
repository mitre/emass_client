...
class PacRequestPostBody(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["workflow", "name", "comments", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["workflow", "name", "comments", ], str]):
