...
class MilestonesGet(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["systemId"], typing_extensions.Literal["milestoneId"], typing_extensions.Literal["poamId"], typing_extensions.Literal["description"], typing_extensions.Literal["scheduledCompletionDate"], typing_extensions.Literal["reviewStatus"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["systemId"], typing_extensions.Literal["milestoneId"], typing_extensions.Literal["poamId"], typing_extensions.Literal["description"], typing_extensions.Literal["scheduledCompletionDate"], typing_extensions.Literal["reviewStatus"], ]):
