...
class PoamPostPutDel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["systemId"], typing_extensions.Literal["poamId"], typing_extensions.Literal["externalUid"], typing_extensions.Literal["success"], typing_extensions.Literal["errors"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["systemId"], typing_extensions.Literal["poamId"], typing_extensions.Literal["externalUid"], typing_extensions.Literal["success"], typing_extensions.Literal["errors"], ]):
