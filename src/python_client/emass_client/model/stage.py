...
class Stage(
        ...
        class properties:
            ...
            class transitions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DefinitionTransitions']:
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["transitions"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["transitions"], ]):
