...
class TestResultsRequestPostBody(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["cci", "testedBy", "testDate", "description", "complianceStatus", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cci", "testedBy", "testDate", "description", "complianceStatus", ], str]):
