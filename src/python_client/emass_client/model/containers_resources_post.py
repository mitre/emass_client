...
class ContainersResourcesPost(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["containerId", "success", "systemId", "errors", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["containerId", "success", "systemId", "errors", ], str]):
