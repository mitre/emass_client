...
class CacGet(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["systemId"], typing_extensions.Literal["controlAcronym"], typing_extensions.Literal["complianceStatus"], typing_extensions.Literal["currentStageName"], typing_extensions.Literal["currentStage"], typing_extensions.Literal["totalStages"], typing_extensions.Literal["comments"], ]):
