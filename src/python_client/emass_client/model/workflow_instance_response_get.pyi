...
class WorkflowInstanceResponseGet(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['WorkflowInstanceGet']:
                        return WorkflowInstanceGet
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['WorkflowInstanceGet'], typing.List['WorkflowInstanceGet']],
                ...
                def __getitem__(self, i: int) -> 'WorkflowInstanceGet':
